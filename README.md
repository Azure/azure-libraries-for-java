...
If you are using released builds from 1.24.0, add the following to your POM file:
...
If you are migrating your code from 1.23.0 to 1.24.0, you can use these release notes for [preparing your code for 1.24.0 from 1.23.0](./notes/prepare-for-1.24.0.md).
