...
For instance, if you only need azure-mgmt-appservice library from 1.36.1, and wish to limit the dependencies, using following dependency instead in POM.
...
If you are using released builds from 1.36.1, add the following to your POM file:
