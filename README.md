...
This README is based on the released stable version (1.32.1). If you are looking for other releases, see [More Information](#more-information).
...
:triangular_flag_on_post: *as of Version 1.32.1*
...
For instance, if you only need azure-mgmt-appservice library from 1.32.1, and wish to limit the dependencies, using following dependency instead in POM.
...
If you are using released builds from 1.32.1, add the following to your POM file:
...
If you are migrating your code from 1.32.0 to 1.32.1, you can use these release notes for [preparing your code for 1.32.1 from 1.32.0](./notes/prepare-for-1.32.1.md).
