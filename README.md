...
For instance, if you only need azure-mgmt-appservice library from 1.33.0, and wish to limit the dependencies, using following dependency instead in POM.
...
If you are using released builds from 1.33.0, add the following to your POM file:
...
If you are migrating your code from 1.32.1 to 1.33.0, you can use these release notes for [preparing your code for 1.33.0 from 1.32.1](./notes/prepare-for-1.33.0.md).
