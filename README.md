...
This README is based on the released stable version (1.11.0). If you are looking for other releases, see [More Information](#more-information).
...
:triangular_flag_on_post: *as of Version 1.11.0*
...
If you are using released builds from 1.11.0, add the following to your POM file:
...
If you are migrating your code from 1.10.x to 1.11.0, you can use these release notes for [preparing your code for 1.11.0 from 1.10.x](./notes/prepare-for-1.11.0.md).
