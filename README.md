...
This README is based on the released stable version (1.33.1). If you are looking for other releases, see [More Information](#more-information).
...
:triangular_flag_on_post: *as of Version 1.33.1*
...
If you are using released builds from 1.33.1, add the following to your POM file:
...
<dependency>
    <groupId>com.microsoft.azure</groupId>
    <artifactId>azure</artifactId>
    <version>1.33.2-SNAPSHOT</version>
</dependency>
<dependency>
    <groupId>com.microsoft.azure</groupId>
...
If you are migrating your code from 1.33.0 to 1.33.1, you can use these release notes for [preparing your code for 1.33.1 from 1.33.0](./notes/prepare-for-1.33.1.md).
