...
This README is based on the released stable version (1.36.3). If you are looking for other releases, see [More Information](#more-information).
...
:triangular_flag_on_post: *as of Version 1.36.3*
...
For instance, if you only need azure-mgmt-appservice library from 1.36.3, and wish to limit the dependencies, using following dependency instead in POM.
...
If you are using released builds from 1.36.3, add the following to your POM file:
...
If you are migrating your code from 1.36.2 to 1.36.3, you can use these release notes for [preparing your code for 1.36.3 from 1.36.2](./notes/prepare-for-1.36.3.md).
...
| 1.36.2       | [1.36.2](https://github.com/Azure/azure-libraries-for-java/tree/v1.36.2)               | Tagged release for 1.36.2 version of Azure management libraries |
