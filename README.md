...
For instance, if you only need azure-mgmt-appservice library from 1.31.0, and wish to limit the dependencies, using following dependency instead in POM.
...
If you are using released builds from 1.31.0, add the following to your POM file:
