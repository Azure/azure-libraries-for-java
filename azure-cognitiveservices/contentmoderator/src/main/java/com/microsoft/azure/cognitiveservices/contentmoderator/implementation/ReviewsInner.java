...
import com.microsoft.azure.cognitiveservices.contentmoderator.Content;
...
public class ReviewsInner {
     ...
     */
    public JobIdInner createJob(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<JobIdInner> createJobAsync(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue, final ServiceCallback<JobIdInner> serviceCallback) {
     ...
     */
    public Observable<JobIdInner> createJobAsync(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue) {
        return createJobWithServiceResponseAsync(teamName, contentType, contentId, workflowName, jobContentType, contentValue).map(new Func1<ServiceResponse<JobIdInner>, JobIdInner>() {
            @Override
     ...
     * @return the observable to the JobIdInner object
     */
    public Observable<ServiceResponse<JobIdInner>> createJobWithServiceResponseAsync(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue) {
        if (this.client.baseUrl() == null) {
            throw new IllegalArgumentException("Parameter this.client.baseUrl() is required and cannot be null.");
        }
        if (teamName == null) {
     ...
     * @return the JobIdInner object if successful.
     */
    public JobIdInner createJob(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue, String callBackEndpoint) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<JobIdInner> createJobAsync(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue, String callBackEndpoint, final ServiceCallback<JobIdInner> serviceCallback) {
     ...
     * @return the observable to the JobIdInner object
     */
    public Observable<JobIdInner> createJobAsync(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue, String callBackEndpoint) {
        return createJobWithServiceResponseAsync(teamName, contentType, contentId, workflowName, jobContentType, contentValue, callBackEndpoint).map(new Func1<ServiceResponse<JobIdInner>, JobIdInner>() {
            @Override
            public JobIdInner call(ServiceResponse<JobIdInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the JobIdInner object
     */
    public Observable<ServiceResponse<JobIdInner>> createJobWithServiceResponseAsync(String teamName, String contentType, String contentId, String workflowName, String jobContentType, String contentValue, String callBackEndpoint) {
        if (this.client.baseUrl() == null) {
            throw new IllegalArgumentException("Parameter this.client.baseUrl() is required and cannot be null.");
        }
        if (teamName == null) {
