...
import com.microsoft.azure.management.advisor.CheckSkuAvailabilityParameter;
import com.microsoft.azure.management.advisor.Kind;
...
public class CheckSkuAvailabilitysInner {
    ...
    interface CheckSkuAvailabilitysService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.advisor.CheckSkuAvailabilitys list" })
