...
import com.microsoft.azure.management.apimanagement.ApiVersionSetContractDetails;
import com.microsoft.azure.management.apimanagement.ContentFormat;
import com.microsoft.azure.management.apimanagement.ApiCreateOrUpdatePropertiesWsdlSelector;
import com.microsoft.azure.management.apimanagement.SoapApiType;
 ...
 */
@JsonFlatten
public class ApiCreateOrUpdateParameterInner {
    /**
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withDescription(String description) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withAuthenticationSettings(AuthenticationSettingsContract authenticationSettings) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withSubscriptionKeyParameterNames(SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withApiType(ApiType apiType) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withApiRevision(String apiRevision) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withApiVersion(String apiVersion) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withApiVersionSetId(String apiVersionSetId) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withDisplayName(String displayName) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withServiceUrl(String serviceUrl) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withProtocols(List<Protocol> protocols) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withApiVersionSet(ApiVersionSetContractDetails apiVersionSet) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withContentValue(String contentValue) {
     ...
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withContentFormat(ContentFormat contentFormat) {
        this.contentFormat = contentFormat;
        return this;
    }

    /**
     * Get the wsdlSelector value.
     *
    ...
    /**
     * Set the wsdlSelector value.
     *
     * @param wsdlSelector the wsdlSelector value to set
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withWsdlSelector(ApiCreateOrUpdatePropertiesWsdlSelector wsdlSelector) {
        this.wsdlSelector = wsdlSelector;
        return this;
    }

    /**
     * Get the soapApiType value.
     *
    ...
    /**
     * Set the soapApiType value.
     *
     * @param soapApiType the soapApiType value to set
     * @return the ApiCreateOrUpdateParameterInner object itself.
     */
    public ApiCreateOrUpdateParameterInner withSoapApiType(SoapApiType soapApiType) {
