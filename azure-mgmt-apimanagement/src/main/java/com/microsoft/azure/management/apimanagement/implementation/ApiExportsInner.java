...
import com.microsoft.azure.management.apimanagement.ExportFormat;
...
public class ApiExportsInner {
    ...
    interface ApiExportsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiExports get" })
     ...
     * @param format Format in which to export the Api Details to the Storage Blob with Sas Key valid for 5 minutes. Possible values include: 'Swagger', 'Wsdl', 'Wadl'
