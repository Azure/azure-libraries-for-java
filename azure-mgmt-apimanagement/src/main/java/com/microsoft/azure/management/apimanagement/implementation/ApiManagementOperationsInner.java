...
public class ApiManagementOperationsInner {
    ...
    interface ApiManagementOperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiManagementOperations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiManagementOperations listNext" })
        @GET
