...
public class ApiPolicysInner {
    ...
    interface ApiPolicysService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiPolicys listByApi" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiPolicys getEntityTag" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiPolicys get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiPolicys createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ApiPolicys delete" })
    ...
    public ServiceFuture<PolicyCollectionInner> listByApiAsync(String resourceGroupName, String serviceName, String apiId, final ServiceCallback<PolicyCollectionInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(listByApiWithServiceResponseAsync(resourceGroupName, serviceName, apiId), serviceCallback);
    }
    ...
    public Observable<PolicyCollectionInner> listByApiAsync(String resourceGroupName, String serviceName, String apiId) {
        return listByApiWithServiceResponseAsync(resourceGroupName, serviceName, apiId).map(new Func1<ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner>, PolicyCollectionInner>() {
            @Override
            public PolicyCollectionInner call(ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner> response) {
     ...
     * @return the observable to the PolicyCollectionInner object
     */
    public Observable<ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner>> listByApiWithServiceResponseAsync(String resourceGroupName, String serviceName, String apiId) {
        ...
        return service.listByApi(resourceGroupName, serviceName, apiId, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner> clientResponse = listByApiDelegate(response);
    ...
    private ServiceResponseWithHeaders<PolicyCollectionInner, ApiPolicyListByApiHeadersInner> listByApiDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PolicyCollectionInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                ...
                .buildWithHeaders(response, ApiPolicyListByApiHeadersInner.class);
    }
    ...
    public Observable<Void> getEntityTagAsync(String resourceGroupName, String serviceName, String apiId) {
        return getEntityTagWithServiceResponseAsync(resourceGroupName, serviceName, apiId).map(new Func1<ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the {@link ServiceResponseWithHeaders} object if successful.
     */
    public Observable<ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner>> getEntityTagWithServiceResponseAsync(String resourceGroupName, String serviceName, String apiId) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        return service.getEntityTag(resourceGroupName, serviceName, apiId, policyId, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<Void>, Observable<ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner>> call(Response<Void> response) {
                    try {
                        ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner> clientResponse = getEntityTagDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<Void, ApiPolicyGetEntityTagHeadersInner> getEntityTagDelegate(Response<Void> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<Void>() { }.getType())
                .registerError(ErrorResponseException.class)
                .buildEmptyWithHeaders(response, ApiPolicyGetEntityTagHeadersInner.class);
    }
    ...
    public Observable<PolicyContractInner> getAsync(String resourceGroupName, String serviceName, String apiId) {
        return getWithServiceResponseAsync(resourceGroupName, serviceName, apiId).map(new Func1<ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner>, PolicyContractInner>() {
            @Override
            public PolicyContractInner call(ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the PolicyContractInner object
     */
    public Observable<ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner>> getWithServiceResponseAsync(String resourceGroupName, String serviceName, String apiId) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        final String policyId = "policy";
        return service.get(resourceGroupName, serviceName, apiId, policyId, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner> clientResponse = getDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<PolicyContractInner, ApiPolicyGetHeadersInner> getDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PolicyContractInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                ...
                .registerError(ErrorResponseException.class)
                .buildWithHeaders(response, ApiPolicyGetHeadersInner.class);
    }
    ...
    public ServiceFuture<PolicyContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, PolicyContractInner parameters, final ServiceCallback<PolicyContractInner> serviceCallback) {
        return ServiceFuture.fromResponse(createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, apiId, parameters), serviceCallback);
    }
    ...
    public Observable<PolicyContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, PolicyContractInner parameters) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, apiId, parameters).map(new Func1<ServiceResponse<PolicyContractInner>, PolicyContractInner>() {
            @Override
     ...
     * @return the observable to the PolicyContractInner object
     */
    public Observable<ServiceResponse<PolicyContractInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String apiId, PolicyContractInner parameters) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
    ...
    public ServiceFuture<PolicyContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, PolicyContractInner parameters, String ifMatch, final ServiceCallback<PolicyContractInner> serviceCallback) {
        return ServiceFuture.fromResponse(createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, apiId, parameters, ifMatch), serviceCallback);
    }
    ...
    public Observable<PolicyContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String apiId, PolicyContractInner parameters, String ifMatch) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, apiId, parameters, ifMatch).map(new Func1<ServiceResponse<PolicyContractInner>, PolicyContractInner>() {
            @Override
            public PolicyContractInner call(ServiceResponse<PolicyContractInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the PolicyContractInner object
     */
    public Observable<ServiceResponse<PolicyContractInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String apiId, PolicyContractInner parameters, String ifMatch) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
