 ...
 */
@JsonFlatten
public class ApiVersionSetUpdateParametersInner {
    /**
     ...
     * @return the ApiVersionSetUpdateParametersInner object itself.
     */
    public ApiVersionSetUpdateParametersInner withDescription(String description) {
     ...
     * @return the ApiVersionSetUpdateParametersInner object itself.
     */
    public ApiVersionSetUpdateParametersInner withVersionQueryName(String versionQueryName) {
     ...
     * @return the ApiVersionSetUpdateParametersInner object itself.
     */
    public ApiVersionSetUpdateParametersInner withVersionHeaderName(String versionHeaderName) {
     ...
     * @return the ApiVersionSetUpdateParametersInner object itself.
     */
    public ApiVersionSetUpdateParametersInner withDisplayName(String displayName) {
     ...
     * @return the ApiVersionSetUpdateParametersInner object itself.
     */
    public ApiVersionSetUpdateParametersInner withVersioningScheme(VersioningScheme versioningScheme) {
