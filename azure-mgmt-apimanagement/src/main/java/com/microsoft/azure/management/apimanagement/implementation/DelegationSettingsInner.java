...
public class DelegationSettingsInner {
    ...
    interface DelegationSettingsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.DelegationSettings getEntityTag" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.DelegationSettings get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.DelegationSettings update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.DelegationSettings createOrUpdate" })
    ...
    public Observable<Void> getEntityTagAsync(String resourceGroupName, String serviceName) {
        return getEntityTagWithServiceResponseAsync(resourceGroupName, serviceName).map(new Func1<ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner> response) {
     ...
     * @return the {@link ServiceResponseWithHeaders} object if successful.
     */
    public Observable<ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner>> getEntityTagWithServiceResponseAsync(String resourceGroupName, String serviceName) {
        ...
        return service.getEntityTag(resourceGroupName, serviceName, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<Void>, Observable<ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner>> call(Response<Void> response) {
                    try {
                        ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner> clientResponse = getEntityTagDelegate(response);
    ...
    private ServiceResponseWithHeaders<Void, DelegationSettingsGetEntityTagHeadersInner> getEntityTagDelegate(Response<Void> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<Void>() { }.getType())
                .registerError(ErrorResponseException.class)
                .buildEmptyWithHeaders(response, DelegationSettingsGetEntityTagHeadersInner.class);
    }
    ...
    public Observable<PortalDelegationSettingsInner> getAsync(String resourceGroupName, String serviceName) {
        return getWithServiceResponseAsync(resourceGroupName, serviceName).map(new Func1<ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner>, PortalDelegationSettingsInner>() {
            @Override
            public PortalDelegationSettingsInner call(ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the PortalDelegationSettingsInner object
     */
    public Observable<ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner>> getWithServiceResponseAsync(String resourceGroupName, String serviceName) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        return service.get(resourceGroupName, serviceName, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner> clientResponse = getDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<PortalDelegationSettingsInner, DelegationSettingsGetHeadersInner> getDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PortalDelegationSettingsInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PortalDelegationSettingsInner>() { }.getType())
                .registerError(CloudException.class)
                .buildWithHeaders(response, DelegationSettingsGetHeadersInner.class);
    }
