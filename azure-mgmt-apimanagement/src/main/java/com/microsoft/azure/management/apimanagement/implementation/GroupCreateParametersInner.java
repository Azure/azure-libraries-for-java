...
public class GroupCreateParametersInner {
     ...
     * @return the GroupCreateParametersInner object itself.
     */
    public GroupCreateParametersInner withDescription(String description) {
     ...
     * @return the GroupCreateParametersInner object itself.
     */
    public GroupCreateParametersInner withType(GroupType type) {
        this.type = type;
        return this;
    }
     ...
     * @return the GroupCreateParametersInner object itself.
     */
    public GroupCreateParametersInner withExternalId(String externalId) {
