 ...
 */
@JsonFlatten
public class LoggerUpdateContractInner {
    /**
     ...
     * @return the LoggerUpdateContractInner object itself.
     */
    public LoggerUpdateContractInner withLoggerType(LoggerType loggerType) {
     ...
     * @return the LoggerUpdateContractInner object itself.
     */
    public LoggerUpdateContractInner withDescription(String description) {
     ...
     * @return the LoggerUpdateContractInner object itself.
     */
    public LoggerUpdateContractInner withCredentials(Map<String, String> credentials) {
     ...
     * @return the LoggerUpdateContractInner object itself.
     */
    public LoggerUpdateContractInner withIsBuffered(Boolean isBuffered) {
