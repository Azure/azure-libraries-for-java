 ...
 */
@JsonFlatten
public class OperationUpdateContractInner {
    /**
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withTemplateParameters(List<ParameterContract> templateParameters) {
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withDescription(String description) {
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withRequest(RequestContract request) {
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withResponses(List<ResponseContract> responses) {
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withPolicies(String policies) {
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withDisplayName(String displayName) {
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withMethod(String method) {
        this.method = method;
        return this;
    }
     ...
     * @return the OperationUpdateContractInner object itself.
     */
    public OperationUpdateContractInner withUrlTemplate(String urlTemplate) {
