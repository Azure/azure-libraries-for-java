...
public class OperationsInner {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Operations listByTags" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Operations listByTagsNext" })
        @GET
    ...
    public Observable<ServiceResponse<Page<TagResourceContractInner>>> listByTagsSinglePageAsync(final String resourceGroupName, final String serviceName, final String apiId) {
        ...
        return service.listByTags(resourceGroupName, serviceName, apiId, this.client.subscriptionId(), filter, top, skip, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the PagedList&lt;TagResourceContractInner&gt; object if successful.
     */
    public PagedList<TagResourceContractInner> listByTags(final String resourceGroupName, final String serviceName, final String apiId, final String filter, final Integer top, final Integer skip) {
        ServiceResponse<Page<TagResourceContractInner>> response = listByTagsSinglePageAsync(resourceGroupName, serviceName, apiId, filter, top, skip).toBlocking().single();
        return new PagedList<TagResourceContractInner>(response.body()) {
            @Override
            public Page<TagResourceContractInner> nextPage(String nextPageLink) {
                return listByTagsNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<TagResourceContractInner>> listByTagsAsync(final String resourceGroupName, final String serviceName, final String apiId, final String filter, final Integer top, final Integer skip, final ListOperationCallback<TagResourceContractInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByTagsSinglePageAsync(resourceGroupName, serviceName, apiId, filter, top, skip),
            new Func1<String, Observable<ServiceResponse<Page<TagResourceContractInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TagResourceContractInner>>> call(String nextPageLink) {
                    return listByTagsNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;TagResourceContractInner&gt; object
     */
    public Observable<Page<TagResourceContractInner>> listByTagsAsync(final String resourceGroupName, final String serviceName, final String apiId, final String filter, final Integer top, final Integer skip) {
        return listByTagsWithServiceResponseAsync(resourceGroupName, serviceName, apiId, filter, top, skip)
            .map(new Func1<ServiceResponse<Page<TagResourceContractInner>>, Page<TagResourceContractInner>>() {
                @Override
                public Page<TagResourceContractInner> call(ServiceResponse<Page<TagResourceContractInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;TagResourceContractInner&gt; object
     */
    public Observable<ServiceResponse<Page<TagResourceContractInner>>> listByTagsWithServiceResponseAsync(final String resourceGroupName, final String serviceName, final String apiId, final String filter, final Integer top, final Integer skip) {
        return listByTagsSinglePageAsync(resourceGroupName, serviceName, apiId, filter, top, skip)
            .concatMap(new Func1<ServiceResponse<Page<TagResourceContractInner>>, Observable<ServiceResponse<Page<TagResourceContractInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<TagResourceContractInner>>> call(ServiceResponse<Page<TagResourceContractInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;TagResourceContractInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<TagResourceContractInner>>> listByTagsSinglePageAsync(final String resourceGroupName, final String serviceName, final String apiId, final String filter, final Integer top, final Integer skip) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
