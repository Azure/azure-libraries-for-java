...
public class PolicySnippetsInner {
    ...
    interface PolicySnippetsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.PolicySnippets listByService" })
    ...
    private ServiceResponse<PolicySnippetsCollectionInner> listByServiceDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PolicySnippetsCollectionInner, CloudException>newInstance(this.client.serializerAdapter())
