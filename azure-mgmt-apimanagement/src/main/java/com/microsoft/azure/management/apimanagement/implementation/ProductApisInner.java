...
public class ProductApisInner {
    ...
    interface ProductApisService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductApis listByProduct" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductApis checkEntityExists" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductApis createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductApis delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductApis listByProductNext" })
        @GET
     ...
     */
    public boolean checkEntityExists(String resourceGroupName, String serviceName, String productId, String apiId) {
        return checkEntityExistsWithServiceResponseAsync(resourceGroupName, serviceName, productId, apiId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Boolean> checkEntityExistsAsync(String resourceGroupName, String serviceName, String productId, String apiId, final ServiceCallback<Boolean> serviceCallback) {
     ...
     */
    public Observable<Boolean> checkEntityExistsAsync(String resourceGroupName, String serviceName, String productId, String apiId) {
        return checkEntityExistsWithServiceResponseAsync(resourceGroupName, serviceName, productId, apiId).map(new Func1<ServiceResponse<Boolean>, Boolean>() {
            @Override
     ...
     * @return the observable to the Boolean object
     */
    public Observable<ServiceResponse<Boolean>> checkEntityExistsWithServiceResponseAsync(String resourceGroupName, String serviceName, String productId, String apiId) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
