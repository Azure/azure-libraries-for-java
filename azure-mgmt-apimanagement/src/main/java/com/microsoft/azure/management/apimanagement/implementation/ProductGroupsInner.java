...
public class ProductGroupsInner {
    ...
    interface ProductGroupsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductGroups listByProduct" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductGroups checkEntityExists" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductGroups createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductGroups delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.ProductGroups listByProductNext" })
        @GET
     ...
     */
    public boolean checkEntityExists(String resourceGroupName, String serviceName, String productId, String groupId) {
        return checkEntityExistsWithServiceResponseAsync(resourceGroupName, serviceName, productId, groupId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Boolean> checkEntityExistsAsync(String resourceGroupName, String serviceName, String productId, String groupId, final ServiceCallback<Boolean> serviceCallback) {
     ...
     */
    public Observable<Boolean> checkEntityExistsAsync(String resourceGroupName, String serviceName, String productId, String groupId) {
        return checkEntityExistsWithServiceResponseAsync(resourceGroupName, serviceName, productId, groupId).map(new Func1<ServiceResponse<Boolean>, Boolean>() {
            @Override
     ...
     * @return the observable to the Boolean object
     */
    public Observable<ServiceResponse<Boolean>> checkEntityExistsWithServiceResponseAsync(String resourceGroupName, String serviceName, String productId, String groupId) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
