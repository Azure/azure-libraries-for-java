 ...
 */
@JsonFlatten
public class ProductUpdateParametersInner {
    /**
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withDescription(String description) {
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withTerms(String terms) {
        this.terms = terms;
        return this;
    }
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withSubscriptionRequired(Boolean subscriptionRequired) {
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withApprovalRequired(Boolean approvalRequired) {
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withSubscriptionsLimit(Integer subscriptionsLimit) {
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withState(ProductState state) {
        this.state = state;
        return this;
    }
     ...
     * @return the ProductUpdateParametersInner object itself.
     */
    public ProductUpdateParametersInner withDisplayName(String displayName) {
