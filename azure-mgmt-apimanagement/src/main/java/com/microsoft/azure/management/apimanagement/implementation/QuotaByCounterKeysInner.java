...
public class QuotaByCounterKeysInner {
    ...
    interface QuotaByCounterKeysService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.QuotaByCounterKeys listByService" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.QuotaByCounterKeys update" })
    ...
    public Observable<ServiceResponse<QuotaCounterCollectionInner>> listByServiceWithServiceResponseAsync(String resourceGroupName, String serviceName, String quotaCounterKey) {
        ...
        return service.listByService(this.client.subscriptionId(), resourceGroupName, serviceName, quotaCounterKey, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    public void update(String resourceGroupName, String serviceName, String quotaCounterKey, QuotaCounterValueContractPropertiesInner parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Void> updateAsync(String resourceGroupName, String serviceName, String quotaCounterKey, QuotaCounterValueContractPropertiesInner parameters, final ServiceCallback<Void> serviceCallback) {
     ...
     */
    public Observable<Void> updateAsync(String resourceGroupName, String serviceName, String quotaCounterKey, QuotaCounterValueContractPropertiesInner parameters) {
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    public Observable<ServiceResponse<Void>> updateWithServiceResponseAsync(String resourceGroupName, String serviceName, String quotaCounterKey, QuotaCounterValueContractPropertiesInner parameters) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
