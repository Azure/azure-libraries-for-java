...
public class RegionsInner {
    ...
    interface RegionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Regions listByService" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Regions listByServiceNext" })
        @GET
    ...
    private ServiceResponse<PageImpl<RegionContractInner>> listByServiceDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<RegionContractInner>, CloudException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<PageImpl<RegionContractInner>> listByServiceNextDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<RegionContractInner>, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<RegionContractInner>>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
