...
public class SignUpSettingsInner {
    ...
    interface SignUpSettingsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.SignUpSettings getEntityTag" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.SignUpSettings get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.SignUpSettings update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.SignUpSettings createOrUpdate" })
    ...
    public Observable<Void> getEntityTagAsync(String resourceGroupName, String serviceName) {
        return getEntityTagWithServiceResponseAsync(resourceGroupName, serviceName).map(new Func1<ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner> response) {
     ...
     * @return the {@link ServiceResponseWithHeaders} object if successful.
     */
    public Observable<ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner>> getEntityTagWithServiceResponseAsync(String resourceGroupName, String serviceName) {
        ...
        return service.getEntityTag(resourceGroupName, serviceName, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<Void>, Observable<ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner>> call(Response<Void> response) {
                    try {
                        ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner> clientResponse = getEntityTagDelegate(response);
    ...
    private ServiceResponseWithHeaders<Void, SignUpSettingsGetEntityTagHeadersInner> getEntityTagDelegate(Response<Void> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<Void>() { }.getType())
                .registerError(ErrorResponseException.class)
                .buildEmptyWithHeaders(response, SignUpSettingsGetEntityTagHeadersInner.class);
    }
    ...
    public Observable<PortalSignupSettingsInner> getAsync(String resourceGroupName, String serviceName) {
        return getWithServiceResponseAsync(resourceGroupName, serviceName).map(new Func1<ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner>, PortalSignupSettingsInner>() {
            @Override
            public PortalSignupSettingsInner call(ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the PortalSignupSettingsInner object
     */
    public Observable<ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner>> getWithServiceResponseAsync(String resourceGroupName, String serviceName) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        return service.get(resourceGroupName, serviceName, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner> clientResponse = getDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<PortalSignupSettingsInner, SignUpSettingsGetHeadersInner> getDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PortalSignupSettingsInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PortalSignupSettingsInner>() { }.getType())
                .registerError(CloudException.class)
                .buildWithHeaders(response, SignUpSettingsGetHeadersInner.class);
    }
