...
public class SubscriptionsInner {
    ...
    interface SubscriptionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions getEntityTag" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions regeneratePrimaryKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions regenerateSecondaryKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.Subscriptions listNext" })
        @GET
    ...
    public Observable<Void> getEntityTagAsync(String resourceGroupName, String serviceName, String sid) {
        return getEntityTagWithServiceResponseAsync(resourceGroupName, serviceName, sid).map(new Func1<ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the {@link ServiceResponseWithHeaders} object if successful.
     */
    public Observable<ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner>> getEntityTagWithServiceResponseAsync(String resourceGroupName, String serviceName, String sid) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        return service.getEntityTag(resourceGroupName, serviceName, sid, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<Void>, Observable<ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner>> call(Response<Void> response) {
                    try {
                        ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner> clientResponse = getEntityTagDelegate(response);
    ...
    private ServiceResponseWithHeaders<Void, SubscriptionGetEntityTagHeadersInner> getEntityTagDelegate(Response<Void> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<Void>() { }.getType())
                .registerError(ErrorResponseException.class)
                .buildEmptyWithHeaders(response, SubscriptionGetEntityTagHeadersInner.class);
    }
    ...
    public Observable<SubscriptionContractInner> getAsync(String resourceGroupName, String serviceName, String sid) {
        return getWithServiceResponseAsync(resourceGroupName, serviceName, sid).map(new Func1<ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner>, SubscriptionContractInner>() {
            @Override
            public SubscriptionContractInner call(ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the SubscriptionContractInner object
     */
    public Observable<ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner>> getWithServiceResponseAsync(String resourceGroupName, String serviceName, String sid) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        return service.get(resourceGroupName, serviceName, sid, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner> clientResponse = getDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<SubscriptionContractInner, SubscriptionGetHeadersInner> getDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<SubscriptionContractInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                ...
                .registerError(ErrorResponseException.class)
                .buildWithHeaders(response, SubscriptionGetHeadersInner.class);
    }
     ...
     * @return the SubscriptionContractInner object if successful.
     */
    public SubscriptionContractInner createOrUpdate(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SubscriptionContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters, final ServiceCallback<SubscriptionContractInner> serviceCallback) {
        return ServiceFuture.fromResponse(createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, sid, parameters), serviceCallback);
    }
     ...
     * @return the observable to the SubscriptionContractInner object
     */
    public Observable<SubscriptionContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, sid, parameters).map(new Func1<ServiceResponse<SubscriptionContractInner>, SubscriptionContractInner>() {
            @Override
            public SubscriptionContractInner call(ServiceResponse<SubscriptionContractInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the SubscriptionContractInner object
     */
    public Observable<ServiceResponse<SubscriptionContractInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
        ...
        return service.createOrUpdate(resourceGroupName, serviceName, sid, this.client.subscriptionId(), parameters, notify, ifMatch, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<SubscriptionContractInner>>>() {
                @Override
                public Observable<ServiceResponse<SubscriptionContractInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<SubscriptionContractInner> clientResponse = createOrUpdateDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
     ...
     * @return the SubscriptionContractInner object if successful.
     */
    public SubscriptionContractInner createOrUpdate(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters, Boolean notify, String ifMatch) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SubscriptionContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters, Boolean notify, String ifMatch, final ServiceCallback<SubscriptionContractInner> serviceCallback) {
        return ServiceFuture.fromResponse(createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, sid, parameters, notify, ifMatch), serviceCallback);
    }
     ...
     * @return the observable to the SubscriptionContractInner object
     */
    public Observable<SubscriptionContractInner> createOrUpdateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters, Boolean notify, String ifMatch) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, serviceName, sid, parameters, notify, ifMatch).map(new Func1<ServiceResponse<SubscriptionContractInner>, SubscriptionContractInner>() {
            @Override
            public SubscriptionContractInner call(ServiceResponse<SubscriptionContractInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the SubscriptionContractInner object
     */
    public Observable<ServiceResponse<SubscriptionContractInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String serviceName, String sid, SubscriptionCreateParametersInner parameters, Boolean notify, String ifMatch) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
    ...
    private ServiceResponse<SubscriptionContractInner> createOrUpdateDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<SubscriptionContractInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<SubscriptionContractInner>() { }.getType())
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    public void update(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Void> updateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch, final ServiceCallback<Void> serviceCallback) {
     ...
     */
    public Observable<Void> updateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch) {
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    public Observable<ServiceResponse<Void>> updateWithServiceResponseAsync(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    public void update(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch, Boolean notify) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Void> updateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch, Boolean notify, final ServiceCallback<Void> serviceCallback) {
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    public Observable<Void> updateAsync(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch, Boolean notify) {
     ...
     * @return the {@link ServiceResponse} object if successful.
     */
    public Observable<ServiceResponse<Void>> updateWithServiceResponseAsync(String resourceGroupName, String serviceName, String sid, SubscriptionUpdateParametersInner parameters, String ifMatch, Boolean notify) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
