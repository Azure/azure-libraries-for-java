...
public class TenantAccessGitsInner {
    ...
    interface TenantAccessGitsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.TenantAccessGits get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.TenantAccessGits regeneratePrimaryKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.TenantAccessGits regenerateSecondaryKey" })
    ...
    public Observable<AccessInformationContractInner> getAsync(String resourceGroupName, String serviceName) {
        return getWithServiceResponseAsync(resourceGroupName, serviceName).map(new Func1<ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner>, AccessInformationContractInner>() {
            @Override
            public AccessInformationContractInner call(ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner> response) {
     ...
     * @return the observable to the AccessInformationContractInner object
     */
    public Observable<ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner>> getWithServiceResponseAsync(String resourceGroupName, String serviceName) {
        ...
        return service.get(resourceGroupName, serviceName, this.client.subscriptionId(), accessName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner> clientResponse = getDelegate(response);
    ...
    private ServiceResponseWithHeaders<AccessInformationContractInner, TenantAccessGitGetHeadersInner> getDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<AccessInformationContractInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                ...
                .buildWithHeaders(response, TenantAccessGitGetHeadersInner.class);
    }
