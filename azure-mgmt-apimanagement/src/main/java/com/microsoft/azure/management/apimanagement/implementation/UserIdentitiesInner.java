...
public class UserIdentitiesInner {
    ...
    interface UserIdentitiesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.UserIdentities list" })
        ...
        Observable<Response<ResponseBody>> list(@Path("resourceGroupName") String resourceGroupName, @Path("serviceName") String serviceName, @Path("uid") String uid, @Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.UserIdentities listNext" })
        @GET
     ...
     */
    public PagedList<UserIdentityContractInner> list(final String resourceGroupName, final String serviceName, final String uid) {
        ServiceResponse<Page<UserIdentityContractInner>> response = listSinglePageAsync(resourceGroupName, serviceName, uid).toBlocking().single();
     ...
     */
    public ServiceFuture<List<UserIdentityContractInner>> listAsync(final String resourceGroupName, final String serviceName, final String uid, final ListOperationCallback<UserIdentityContractInner> serviceCallback) {
     ...
     */
    public Observable<Page<UserIdentityContractInner>> listAsync(final String resourceGroupName, final String serviceName, final String uid) {
     ...
     * @return the observable to the PagedList&lt;UserIdentityContractInner&gt; object
     */
    public Observable<ServiceResponse<Page<UserIdentityContractInner>>> listWithServiceResponseAsync(final String resourceGroupName, final String serviceName, final String uid) {
    ...
    ServiceResponse<PageImpl<UserIdentityContractInner>> * @param uid User identifier. Must be unique in the current API Management service instance.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;UserIdentityContractInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<UserIdentityContractInner>>> listSinglePageAsync(final String resourceGroupName, final String serviceName, final String uid) {
        ...
        return service.list(resourceGroupName, serviceName, uid, this.client.subscriptionId(), this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
