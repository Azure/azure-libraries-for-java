...
public class UserSubscriptionsInner {
    ...
    interface UserSubscriptionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.UserSubscriptions list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.apimanagement.UserSubscriptions listNext" })
        @GET
     ...
     */
    public PagedList<SubscriptionContractInner> list(final String resourceGroupName, final String serviceName, final String uid) {
        ServiceResponse<Page<SubscriptionContractInner>> response = listSinglePageAsync(resourceGroupName, serviceName, uid).toBlocking().single();
     ...
     */
    public ServiceFuture<List<SubscriptionContractInner>> listAsync(final String resourceGroupName, final String serviceName, final String uid, final ListOperationCallback<SubscriptionContractInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listSinglePageAsync(resourceGroupName, serviceName, uid),
     ...
     */
    public Observable<Page<SubscriptionContractInner>> listAsync(final String resourceGroupName, final String serviceName, final String uid) {
        return listWithServiceResponseAsync(resourceGroupName, serviceName, uid)
     ...
     * @return the observable to the PagedList&lt;SubscriptionContractInner&gt; object
     */
    public Observable<ServiceResponse<Page<SubscriptionContractInner>>> listWithServiceResponseAsync(final String resourceGroupName, final String serviceName, final String uid) {
        return listSinglePageAsync(resourceGroupName, serviceName, uid)
     ...
     */
    public Observable<ServiceResponse<Page<SubscriptionContractInner>>> listSinglePageAsync(final String resourceGroupName, final String serviceName, final String uid) {
        ...
        return service.list(resourceGroupName, serviceName, uid, this.client.subscriptionId(), filter, top, skip, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the PagedList&lt;SubscriptionContractInner&gt; object if successful.
     */
    public PagedList<SubscriptionContractInner> list(final String resourceGroupName, final String serviceName, final String uid, final String filter, final Integer top, final Integer skip) {
        ServiceResponse<Page<SubscriptionContractInner>> response = listSinglePageAsync(resourceGroupName, serviceName, uid, filter, top, skip).toBlocking().single();
        return new PagedList<SubscriptionContractInner>(response.body()) {
            @Override
            public Page<SubscriptionContractInner> nextPage(String nextPageLink) {
                return listNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<SubscriptionContractInner>> listAsync(final String resourceGroupName, final String serviceName, final String uid, final String filter, final Integer top, final Integer skip, final ListOperationCallback<SubscriptionContractInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listSinglePageAsync(resourceGroupName, serviceName, uid, filter, top, skip),
            new Func1<String, Observable<ServiceResponse<Page<SubscriptionContractInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<SubscriptionContractInner>>> call(String nextPageLink) {
                    return listNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;SubscriptionContractInner&gt; object
     */
    public Observable<Page<SubscriptionContractInner>> listAsync(final String resourceGroupName, final String serviceName, final String uid, final String filter, final Integer top, final Integer skip) {
        return listWithServiceResponseAsync(resourceGroupName, serviceName, uid, filter, top, skip)
            .map(new Func1<ServiceResponse<Page<SubscriptionContractInner>>, Page<SubscriptionContractInner>>() {
                @Override
                public Page<SubscriptionContractInner> call(ServiceResponse<Page<SubscriptionContractInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;SubscriptionContractInner&gt; object
     */
    public Observable<ServiceResponse<Page<SubscriptionContractInner>>> listWithServiceResponseAsync(final String resourceGroupName, final String serviceName, final String uid, final String filter, final Integer top, final Integer skip) {
        return listSinglePageAsync(resourceGroupName, serviceName, uid, filter, top, skip)
            .concatMap(new Func1<ServiceResponse<Page<SubscriptionContractInner>>, Observable<ServiceResponse<Page<SubscriptionContractInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<SubscriptionContractInner>>> call(ServiceResponse<Page<SubscriptionContractInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
    ...
    ServiceResponse<PageImpl<SubscriptionContractInner>> * @param uid User identifier. Must be unique in the current API Management service instance.
     ...
     * @return the PagedList&lt;SubscriptionContractInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<SubscriptionContractInner>>> listSinglePageAsync(final String resourceGroupName, final String serviceName, final String uid, final String filter, final Integer top, final Integer skip) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serviceName == null) {
