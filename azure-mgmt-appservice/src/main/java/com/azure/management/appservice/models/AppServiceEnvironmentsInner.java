...
public final class AppServiceEnvironmentsInner implements InnerSupportsGet<AppServiceEnvironmentResourceInner>, InnerSupportsListing<AppServiceEnvironmentResourceInner>, InnerSupportsDelete<Void> {
    ...
    private interface AppServiceEnvironmentsService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseException.class)
        Mono<SimpleResponse<Flux<ByteBuffer>>> changeVnetNext(@PathParam(value = "nextLink", encoded = true) String nextLink);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseException.class)
        Mono<SimpleResponse<Flux<ByteBuffer>>> resumeNext(@PathParam(value = "nextLink", encoded = true) String nextLink);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseException.class)
        Mono<SimpleResponse<Flux<ByteBuffer>>> suspendNext(@PathParam(value = "nextLink", encoded = true) String nextLink);
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseException.class)
        Mono<SimpleResponse<WebAppCollectionInner>> beginChangeVnetNext(@PathParam(value = "nextLink", encoded = true) String nextLink);

        @Get("{nextLink}")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseException.class)
        Mono<SimpleResponse<WebAppCollectionInner>> beginResumeNext(@PathParam(value = "nextLink", encoded = true) String nextLink);

        @Get("{nextLink}")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseException.class)
        Mono<SimpleResponse<WebAppCollectionInner>> beginSuspendNext(@PathParam(value = "nextLink", encoded = true) String nextLink);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> changeVnetSinglePageAsync(String resourceGroupName, String name, VirtualNetworkProfile vnetInfo) {
        return service.changeVnet(this.client.getHost(), resourceGroupName, name, this.client.getSubscriptionId(), vnetInfo, this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
    ...
    public PagedFlux<SiteInner> changeVnetAsync(String resourceGroupName, String name, VirtualNetworkProfile vnetInfo) {
        return new PagedFlux<>(
            ...
            nextLink -> beginChangeVnetNextSinglePageAsync(nextLink));
    }
    ...
    public Mono<PagedResponse<SiteInner>> resumeSinglePageAsync(String resourceGroupName, String name) {
        return service.resume(this.client.getHost(), resourceGroupName, name, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
    ...
    public PagedFlux<SiteInner> resumeAsync(String resourceGroupName, String name) {
        return new PagedFlux<>(
            ...
            nextLink -> beginResumeNextSinglePageAsync(nextLink));
    }
    ...
    public Mono<PagedResponse<SiteInner>> suspendSinglePageAsync(String resourceGroupName, String name) {
        return service.suspend(this.client.getHost(), resourceGroupName, name, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
    ...
    public PagedFlux<SiteInner> suspendAsync(String resourceGroupName, String name) {
        return new PagedFlux<>(
            ...
            nextLink -> beginSuspendNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> beginChangeVnetSinglePageAsync(String resourceGroupName, String name, VirtualNetworkProfile vnetInfo) {
        return service.beginChangeVnet(this.client.getHost(), resourceGroupName, name, this.client.getSubscriptionId(), vnetInfo, this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SiteInner> beginChangeVnetAsync(String resourceGroupName, String name, VirtualNetworkProfile vnetInfo) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SiteInner> beginChangeVnet(String resourceGroupName, String name, VirtualNetworkProfile vnetInfo) {
        return new PagedIterable<>(beginChangeVnetAsync(resourceGroupName, name, vnetInfo));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> beginResumeSinglePageAsync(String resourceGroupName, String name) {
        return service.beginResume(this.client.getHost(), resourceGroupName, name, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SiteInner> beginResumeAsync(String resourceGroupName, String name) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SiteInner> beginResume(String resourceGroupName, String name) {
        return new PagedIterable<>(beginResumeAsync(resourceGroupName, name));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> beginSuspendSinglePageAsync(String resourceGroupName, String name) {
        return service.beginSuspend(this.client.getHost(), resourceGroupName, name, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SiteInner> beginSuspendAsync(String resourceGroupName, String name) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SiteInner> beginSuspend(String resourceGroupName, String name) {
        return new PagedIterable<>(beginSuspendAsync(resourceGroupName, name));
    }
    ...
    public Mono<PagedResponse<SiteInner>> changeVnetNextSinglePageAsync(String nextLink) {
        return service.changeVnetNext(nextLink).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SiteInner> changeVnetNextAsync(String nextLink) {
        return new PagedFlux<>(
            () -> changeVnetNextSinglePageAsync(nextLink),
            nextLink -> beginChangeVnetNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SiteInner> changeVnetNext(String nextLink) {
        return new PagedIterable<>(changeVnetNextAsync(nextLink));
    }
    ...
    public Mono<PagedResponse<SiteInner>> resumeNextSinglePageAsync(String nextLink) {
        return service.resumeNext(nextLink).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SiteInner> resumeNextAsync(String nextLink) {
        return new PagedFlux<>(
            () -> resumeNextSinglePageAsync(nextLink),
            nextLink -> beginResumeNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SiteInner> resumeNext(String nextLink) {
        return new PagedIterable<>(resumeNextAsync(nextLink));
    }
    ...
    public Mono<PagedResponse<SiteInner>> suspendNextSinglePageAsync(String nextLink) {
        return service.suspendNext(nextLink).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SiteInner> suspendNextAsync(String nextLink) {
        return new PagedFlux<>(
            () -> suspendNextSinglePageAsync(nextLink),
            nextLink -> beginSuspendNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<SiteInner> suspendNext(String nextLink) {
        return new PagedIterable<>(suspendNextAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> beginChangeVnetNextSinglePageAsync(String nextLink) {
        return service.beginChangeVnetNext(nextLink).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> beginResumeNextSinglePageAsync(String nextLink) {
        return service.beginResumeNext(nextLink).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SiteInner>> beginSuspendNextSinglePageAsync(String nextLink) {
        return service.beginSuspendNext(nextLink).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().value(),
