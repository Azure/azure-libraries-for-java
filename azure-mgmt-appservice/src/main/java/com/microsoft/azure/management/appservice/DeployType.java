...
public class DeployType extends ExpandableStringEnum<DeployType> {
     ...
     *
     * If {@code DeployOptions.path} is provided, {@code path=webapps/<appname>} will behave exactly like wardeploy by unzipping app to {@code /home/site/wwwroot/webapps/<appname>}.
     */
    ...
    /**
     * Deploy the script file to {@code /home/site/scripts/}. {@code DeployOptions.path} parameter needs to be specified.
     */
