...
class KuduClient {
    ...
    private interface KuduService {
        ...
        @Headers({ "Content-Type: application/octet-stream", "x-ms-logging-context: com.microsoft.azure.management.appservice.WebApps oneDeploy", "x-ms-body-logging: false" })
        @POST("api/publish")
        @Streaming
