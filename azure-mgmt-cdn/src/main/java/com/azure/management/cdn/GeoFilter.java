...
public final class GeoFilter {
    ...
    /**
     * Get the action property: Action of the geo filter, i.e. allow or block
     * access.
     * 
    ...
    /**
     * Set the action property: Action of the geo filter, i.e. allow or block
     * access.
     * 
    ...
    /**
     * Get the countryCodes property: Two letter country codes defining user
    ...
    /**
     * Set the countryCodes property: Two letter country codes defining user
     * country access in a geo filter, e.g. AU, MX, US.
     * 
