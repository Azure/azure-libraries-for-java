...
public final class KeyVaultCertificateSourceParameters {
    ...
    /**
     * Get the subscriptionId property: Subscription Id of the user's Key Vault
    ...
    /**
     * Set the subscriptionId property: Subscription Id of the user's Key Vault
     * containing the SSL certificate.
     * 
    ...
    /**
     * Get the resourceGroupName property: Resource group of the user's Key
    ...
    /**
     * Set the resourceGroupName property: Resource group of the user's Key
     * Vault containing the SSL certificate.
     * 
    ...
    /**
     * Get the vaultName property: The name of the user's Key Vault containing
     * the SSL certificate.
     * 
    ...
    /**
     * Set the vaultName property: The name of the user's Key Vault containing
     * the SSL certificate.
     * 
    ...
    /**
     * Get the secretName property: The name of Key Vault Secret (representing
    ...
    /**
     * Set the secretName property: The name of Key Vault Secret (representing
     * the full certificate PFX) in Key Vault.
     * 
    ...
    /**
     * Get the secretVersion property: The version(GUID) of Key Vault Secret in
     * Key Vault.
     * 
    ...
    /**
     * Set the secretVersion property: The version(GUID) of Key Vault Secret in
     * Key Vault.
     * 
    ...
    /**
     * Get the updateRule property: Describes the action that shall be taken
     * when the certificate is updated in Key Vault.
     * 
    ...
    /**
     * Set the updateRule property: Describes the action that shall be taken
     * when the certificate is updated in Key Vault.
     * 
    ...
    /**
     * Get the deleteRule property: Describes the action that shall be taken
     * when the certificate is removed from Key Vault.
     * 
    ...
    /**
     * Set the deleteRule property: Describes the action that shall be taken
     * when the certificate is removed from Key Vault.
     * 
