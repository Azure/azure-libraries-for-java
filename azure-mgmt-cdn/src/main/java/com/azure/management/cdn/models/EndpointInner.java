...
import com.azure.management.cdn.DeepCreatedOrigin;
import com.azure.management.cdn.EndpointPropertiesUpdateParametersDeliveryPolicy;
import com.azure.management.cdn.EndpointResourceState;
import com.azure.management.cdn.GeoFilter;
import com.azure.management.cdn.OptimizationType;
import com.azure.management.cdn.QueryStringCachingBehavior;
...
public class EndpointInner extends Resource {
    ...
    /**
     * Get the originHostHeader property: The host header value sent to the
     ...
     * Storage, and Cloud Services require this host header value to match the
    ...
    /**
     * Set the originHostHeader property: The host header value sent to the
     * origin with each request. If you leave this blank, the request hostname
     * determines this value. Azure CDN origins, such as Web Apps, Blob
     * Storage, and Cloud Services require this host header value to match the
     * origin hostname by default.
    ...
    /**
     * Get the originPath property: A directory path on the origin that CDN can
    ...
    /**
     * Set the originPath property: A directory path on the origin that CDN can
     * use to retrieve content from, e.g. contoso.cloudapp.net/originpath.
     * 
    ...
    /**
     * Get the contentTypesToCompress property: List of content types on which
    ...
    /**
     * Set the contentTypesToCompress property: List of content types on which
     * compression applies. The value should be a valid MIME type.
     * 
    ...
    /**
     * Get the isCompressionEnabled property: Indicates whether content
    ...
    /**
     * Set the isCompressionEnabled property: Indicates whether content
     * compression is enabled on CDN. Default value is false. If compression is
     * enabled, content will be served as compressed if user requests for a
     * compressed version. Content won't be compressed on CDN when requested
     * content is smaller than 1 byte or larger than 1 MB.
    ...
    /**
     * Get the isHttpAllowed property: Indicates whether HTTP traffic is
    ...
    /**
     * Set the isHttpAllowed property: Indicates whether HTTP traffic is
     * allowed on the endpoint. Default value is true. At least one protocol
     * (HTTP or HTTPS) must be allowed.
     * 
    ...
    /**
     * Get the isHttpsAllowed property: Indicates whether HTTPS traffic is
     * allowed on the endpoint. Default value is true. At least one protocol
     * (HTTP or HTTPS) must be allowed.
     * 
    ...
    /**
     * Set the isHttpsAllowed property: Indicates whether HTTPS traffic is
     * allowed on the endpoint. Default value is true. At least one protocol
     * (HTTP or HTTPS) must be allowed.
     * 
    ...
    /**
     * Get the queryStringCachingBehavior property: Defines how CDN caches
    ...
    /**
     * Set the queryStringCachingBehavior property: Defines how CDN caches
     * requests that include query strings. You can ignore any query strings
     * when caching, bypass caching to prevent requests that contain query
     * strings from being cached, or cache every request with a unique URL.
     * 
     * @param queryStringCachingBehavior the queryStringCachingBehavior value
     * to set.
     * @return the EndpointInner object itself.
     */
    ...
    /**
     * Get the optimizationType property: Specifies what scenario the customer
    ...
    /**
     * Set the optimizationType property: Specifies what scenario the customer
     * wants this CDN endpoint to optimize for, e.g. Download, Media services.
     * With this information, CDN can apply scenario driven optimization.
     * 
    ...
    /**
     * Get the probePath property: Path to a file hosted on the origin which
    ...
    /**
     * Set the probePath property: Path to a file hosted on the origin which
     * helps accelerate delivery of the dynamic content and calculate the most
     * optimal routes for the CDN. This is relative to the origin path.
     * 
    ...
    /**
     * Get the geoFilters property: List of rules defining the user's geo
     * access within a CDN endpoint. Each geo filter defines an access rule to
     * a specified path or content, e.g. block APAC for path /pictures/.
     * 
    ...
    /**
     * Set the geoFilters property: List of rules defining the user's geo
     * access within a CDN endpoint. Each geo filter defines an access rule to
     * a specified path or content, e.g. block APAC for path /pictures/.
     * 
    ...
    /**
     * Get the deliveryPolicy property: A policy that specifies the delivery
    ...
    /**
     * Set the deliveryPolicy property: A policy that specifies the delivery
     * rules to be used for an endpoint.
     * 
