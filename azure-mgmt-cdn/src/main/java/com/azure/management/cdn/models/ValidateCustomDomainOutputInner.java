...
/**
 * The ValidateCustomDomainOutput model.
 */
@Immutable
public final class ValidateCustomDomainOutputInner {
    ...
    /**
     * Get the customDomainValidated property: Indicates whether the custom
    ...
    /**
     * Get the message property: Error message describing why the custom domain
     * is not valid.
     * 
