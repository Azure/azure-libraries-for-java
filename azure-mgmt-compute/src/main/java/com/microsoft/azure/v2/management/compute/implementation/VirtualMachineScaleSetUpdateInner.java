...
import com.microsoft.azure.v2.management.compute.UpdateResource;
 ...
 */
@JsonFlatten
public class VirtualMachineScaleSetUpdateInner extends UpdateResource {
    /**
    ...
    private VirtualMachineScaleSetUpdateVMProfileInner virtualMachineProfile;
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withPlan(Plan plan) {
        this.plan = plan;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withUpgradePolicy(UpgradePolicy upgradePolicy) {
     ...
     */
    public VirtualMachineScaleSetUpdateVMProfileInner virtualMachineProfile() {
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withVirtualMachineProfile(VirtualMachineScaleSetUpdateVMProfileInner virtualMachineProfile) {
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withOverprovision(Boolean overprovision) {
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withSinglePlacementGroup(Boolean singlePlacementGroup) {
     ...
     * @return the VirtualMachineScaleSetUpdateInner object itself.
     */
    public VirtualMachineScaleSetUpdateInner withIdentity(VirtualMachineScaleSetIdentity identity) {
