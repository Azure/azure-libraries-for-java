...
public class PriceSheetsInner {
    ...
    interface PriceSheetsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.consumption.PriceSheets get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.consumption.PriceSheets getByBillingPeriod" })
     ...
     * @return the PriceSheetResultInner object if successful.
     */
    public PriceSheetResultInner get(String expand, String skiptoken) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PriceSheetResultInner> getAsync(String expand, String skiptoken, final ServiceCallback<PriceSheetResultInner> serviceCallback) {
     ...
     * @return the observable to the PriceSheetResultInner object
     */
    public Observable<PriceSheetResultInner> getAsync(String expand, String skiptoken) {
        return getWithServiceResponseAsync(expand, skiptoken).map(new Func1<ServiceResponse<PriceSheetResultInner>, PriceSheetResultInner>() {
            @Override
            public PriceSheetResultInner call(ServiceResponse<PriceSheetResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the PriceSheetResultInner object
     */
    public Observable<ServiceResponse<PriceSheetResultInner>> getWithServiceResponseAsync(String expand, String skiptoken) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
     ...
     * @return the PriceSheetResultInner object if successful.
     */
    public PriceSheetResultInner getByBillingPeriod(String billingPeriodName, String expand, String skiptoken) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PriceSheetResultInner> getByBillingPeriodAsync(String billingPeriodName, String expand, String skiptoken, final ServiceCallback<PriceSheetResultInner> serviceCallback) {
     ...
     * @return the observable to the PriceSheetResultInner object
     */
    public Observable<PriceSheetResultInner> getByBillingPeriodAsync(String billingPeriodName, String expand, String skiptoken) {
        return getByBillingPeriodWithServiceResponseAsync(billingPeriodName, expand, skiptoken).map(new Func1<ServiceResponse<PriceSheetResultInner>, PriceSheetResultInner>() {
            @Override
            public PriceSheetResultInner call(ServiceResponse<PriceSheetResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the PriceSheetResultInner object
     */
    public Observable<ServiceResponse<PriceSheetResultInner>> getByBillingPeriodWithServiceResponseAsync(String billingPeriodName, String expand, String skiptoken) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (billingPeriodName == null) {
