...
public final class CollectionPartitionsInner {
     ...
     */
    public CollectionPartitionsInner(CosmosDBManagementClientImpl client) {
     ...
     * CosmosDBManagementClientCollectionPartitions to be used by the proxy
    ...
    private interface CollectionPartitionsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<PartitionUsagesResultInner>> listUsages(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("accountName") String accountName, @PathParam("databaseRid") String databaseRid, @PathParam("collectionRid") String collectionRid, @QueryParam("api-version") String apiVersion, @QueryParam("$filter") String filter, @QueryParam("api-version") String apiVersion);
    }
    ...
    public Mono<PagedResponse<PartitionMetricInner>> listMetricsSinglePageAsync(String resourceGroupName, String accountName, String databaseRid, String collectionRid, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PartitionUsageInner>> listUsagesSinglePageAsync(String resourceGroupName, String accountName, String databaseRid, String collectionRid, String filter) {
        final String apiVersion = "2019-08-01";
        final String apiVersion = "2019-08-01";
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PartitionUsageInner> listUsages(String resourceGroupName, String accountName, String databaseRid, String collectionRid, String filter) {
