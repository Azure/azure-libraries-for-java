...
public final class PartitionKeyRangeIdsInner {
     ...
     */
    public PartitionKeyRangeIdsInner(CosmosDBManagementClientImpl client) {
     ...
     * CosmosDBManagementClientPartitionKeyRangeIds to be used by the proxy
     * service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "CosmosDBManagementClientPartitionKeyRangeIds")
