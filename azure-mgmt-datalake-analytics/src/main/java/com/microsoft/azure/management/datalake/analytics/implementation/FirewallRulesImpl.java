...
import com.microsoft.azure.management.datalake.analytics.models.CreateOrUpdateFirewallRuleParameters;
...
public class FirewallRulesImpl implements FirewallRules {
    ...
    interface FirewallRulesService {
        ...
        Observable<Response<ResponseBody>> update(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("accountName") String accountName, @Path("firewallRuleName") String firewallRuleName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body UpdateFirewallRuleParameters parameters, @Header("User-Agent") String userAgent);
    ...
    public FirewallRule createOrUpdate(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FirewallRule> createOrUpdateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress, final ServiceCallback<FirewallRule> serviceCallback) {
        return ServiceFuture.fromResponse(createOrUpdateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress), serviceCallback);
    }
    ...
    public Observable<FirewallRule> createOrUpdateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress).map(new Func1<ServiceResponse<FirewallRule>, FirewallRule>() {
            @Override
    ...
    public Observable<ServiceResponse<FirewallRule>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        ...
        return service.createOrUpdate(this.client.subscriptionId(), resourceGroupName, accountName, firewallRuleName, this.client.apiVersion(), this.client.acceptLanguage(), parameters, this.client.userAgent())
    ...
    public Observable<ServiceResponse<FirewallRule>> updateWithServiceResponseAsync(String resourceGroupName, String accountName, String firewallRuleName) {
        ...
        final String startIpAddress = null;
        final String endIpAddress = null;
        ...
        return service.update(this.client.subscriptionId(), resourceGroupName, accountName, firewallRuleName, this.client.apiVersion(), this.client.acceptLanguage(), parameters, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<FirewallRule>>>() {
                @Override
                public Observable<ServiceResponse<FirewallRule>> call(Response<ResponseBody> response) {
                    try {
    ...
    public FirewallRule update(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        return updateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FirewallRule> updateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress, final ServiceCallback<FirewallRule> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress), serviceCallback);
    }
    ...
    public Observable<FirewallRule> updateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        return updateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress).map(new Func1<ServiceResponse<FirewallRule>, FirewallRule>() {
            @Override
            public FirewallRule call(ServiceResponse<FirewallRule> response) {
                return response.body();
            }
