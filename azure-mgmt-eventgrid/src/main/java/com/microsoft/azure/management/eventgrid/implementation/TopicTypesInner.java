...
public class TopicTypesInner {
    ...
    interface TopicTypesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.eventgrid.TopicTypes list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.eventgrid.TopicTypes get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.eventgrid.TopicTypes listEventTypes" })
            ...
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<List<TopicTypeInfoInner>>>>() {
                ...
                public Observable<ServiceResponse<List<TopicTypeInfoInner>>> call(Response<ResponseBody> response) {
                    try {
                        ...
                        ServiceResponse<List<TopicTypeInfoInner>> clientResponse = new ServiceResponse<List<TopicTypeInfoInner>>(result.body().items(), result.response());
