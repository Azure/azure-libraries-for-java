...
import com.microsoft.azure.management.eventgrid.Topics;
...
class TopicsImpl extends GroupableResourcesImpl<Topic, TopicImpl, TopicInner, TopicsInner, EventGridManager>  implements Topics {
    ...
    protected TopicImpl wrapModel(TopicInner inner) {
        return  new TopicImpl(inner.name(), inner, this.manager());
    }
