 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "objectType", defaultImpl = DirectoryObject.class)
...
public class DirectoryObject {
     ...
     * @return the DirectoryObject object itself.
     */
    public DirectoryObject setAdditionalProperties(Map<String, Object> additionalProperties) {
