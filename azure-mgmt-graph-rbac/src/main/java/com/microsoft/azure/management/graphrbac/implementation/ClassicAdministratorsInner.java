...
public class ClassicAdministratorsInner {
    ...
    interface ClassicAdministratorsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.graphrbac.ClassicAdministrators list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.graphrbac.ClassicAdministrators listNext" })
        @GET
