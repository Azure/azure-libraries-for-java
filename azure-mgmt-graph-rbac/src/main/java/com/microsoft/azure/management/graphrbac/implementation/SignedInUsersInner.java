...
public class SignedInUsersInner {
    ...
    interface SignedInUsersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.graphrbac.SignedInUsers get" })
        @GET("{tenantID}/me")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.graphrbac.SignedInUsers listOwnedObjects" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.graphrbac.SignedInUsers listOwnedObjectsNext" })
        @GET
