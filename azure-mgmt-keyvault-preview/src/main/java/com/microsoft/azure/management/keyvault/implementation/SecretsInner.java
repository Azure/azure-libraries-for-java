...
public class SecretsInner {
    ...
    interface SecretsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.keyvault.Secrets createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.keyvault.Secrets update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.keyvault.Secrets get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.keyvault.Secrets list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.keyvault.Secrets listNext" })
        @GET
     ...
     */
    public SecretInner createOrUpdate(String resourceGroupName, String vaultName, String secretName, SecretCreateOrUpdateParametersInner parameters) {
     ...
     */
    public ServiceFuture<SecretInner> createOrUpdateAsync(String resourceGroupName, String vaultName, String secretName, SecretCreateOrUpdateParametersInner parameters, final ServiceCallback<SecretInner> serviceCallback) {
     ...
     */
    public Observable<SecretInner> createOrUpdateAsync(String resourceGroupName, String vaultName, String secretName, SecretCreateOrUpdateParametersInner parameters) {
     ...
     * @return the observable to the SecretInner object
     */
    public Observable<ServiceResponse<SecretInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String vaultName, String secretName, SecretCreateOrUpdateParametersInner parameters) {
     ...
     * @return the SecretInner object if successful.
     */
    public SecretInner update(String resourceGroupName, String vaultName, String secretName, SecretPatchParametersInner parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SecretInner> updateAsync(String resourceGroupName, String vaultName, String secretName, SecretPatchParametersInner parameters, final ServiceCallback<SecretInner> serviceCallback) {
     ...
     * @return the observable to the SecretInner object
     */
    public Observable<SecretInner> updateAsync(String resourceGroupName, String vaultName, String secretName, SecretPatchParametersInner parameters) {
     ...
     * @return the observable to the SecretInner object
     */
    public Observable<ServiceResponse<SecretInner>> updateWithServiceResponseAsync(String resourceGroupName, String vaultName, String secretName, SecretPatchParametersInner parameters) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (vaultName == null) {
