...
* Get Job.
    ...
    * @return the observable for the request
    */
    Observable<Job> getByTransformAsync(String resourceGroupName, String accountName, String transformName, String jobName);
...
* Delete Job.
    ...
    * @return the observable for the request
    */
    Completable deleteByTransformAsync(String resourceGroupName, String accountName, String transformName, String jobName);
    /**
* Cancel Job.
    * Cancel a Job.
    *
