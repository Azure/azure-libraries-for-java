...
import com.microsoft.azure.management.mediaservices.implementation.LiveEventInner;
...
public interface LiveEvent extends HasInner<LiveEventInner>, Indexable, Refreshable<LiveEvent>, Updatable<LiveEvent.Update>, HasManager<MediaManager> {
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the  update allowing to specify Encoding.
         */
        ...
        /**
         * The stage of the  update allowing to specify Input.
         */
        interface WithInput {
            /**
             * Specifies input.
        ...
        /**
         * The stage of the  update allowing to specify Preview.
         */
        ...
        /**
         * The stage of the  update allowing to specify StreamOptions.
         */
        ...
        /**
         * The stage of the  update allowing to specify VanityUrl.
         */
         ...
         */
        interface WithCreate extends Creatable<LiveEvent>, DefinitionStages.WithCrossSiteAccessPolicies, DefinitionStages.WithDescription, DefinitionStages.WithEncoding, DefinitionStages.WithInput, DefinitionStages.WithLocation, DefinitionStages.WithPreview, DefinitionStages.WithStreamOptions, DefinitionStages.WithTags, DefinitionStages.WithVanityUrl {
        }
    }
    /**
     * The template for a LiveEvent update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<LiveEvent>, UpdateStages.WithCrossSiteAccessPolicies, UpdateStages.WithDescription, UpdateStages.WithEncoding, UpdateStages.WithInput, UpdateStages.WithLocation, UpdateStages.WithPreview, UpdateStages.WithStreamOptions, UpdateStages.WithTags, UpdateStages.WithVanityUrl {
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the  {0} allowing to specify Encoding.
         */
        interface WithEncoding {
            /**
             * Specifies encoding.
        ...
        /**
         * The stage of the  {0} allowing to specify Input.
         */
        interface WithInput {
            /**
             * Specifies input.
        ...
        /**
         * The stage of the  {0} allowing to specify Preview.
         */
        interface WithPreview {
            /**
             * Specifies preview.
        ...
        /**
         * The stage of the  {0} allowing to specify StreamOptions.
         */
        interface WithStreamOptions {
            /**
             * Specifies streamOptions.
        ...
        /**
         * The stage of the  {0} allowing to specify VanityUrl.
         */
        interface WithVanityUrl {
            /**
             * Specifies vanityUrl.
