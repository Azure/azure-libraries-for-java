...
import com.microsoft.azure.management.mediaservices.implementation.MediaServiceInner;

/**
 * Type representing MediaService.
 */
public interface MediaService extends HasInner<MediaServiceInner>, Resource, GroupableResource<MediaManager, MediaServiceInner>, HasResourceGroup, Refreshable<MediaService>, Updatable<MediaService.Update>, HasManager<MediaManager> {
    /**
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the  update allowing to specify StorageAccounts.
         */
    ...
    interface UpdateStages {
        /**
         * The stage of the  {0} allowing to specify StorageAccounts.
         */
        interface WithStorageAccounts {
            /**
             * Specifies storageAccounts.
