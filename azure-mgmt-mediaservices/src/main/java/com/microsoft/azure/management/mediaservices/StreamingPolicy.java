...
import com.microsoft.azure.management.mediaservices.implementation.StreamingPolicyInner;
...
public interface StreamingPolicy extends HasInner<StreamingPolicyInner>, Indexable, Refreshable<StreamingPolicy>, Updatable<StreamingPolicy.Update>, HasManager<MediaManager> {
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the  update allowing to specify CommonEncryptionCbcs.
         */
        ...
        /**
         * The stage of the  update allowing to specify CommonEncryptionCenc.
         */
        ...
        /**
         * The stage of the  update allowing to specify EnvelopeEncryption.
         */
        ...
        /**
         * The stage of the  update allowing to specify NoEncryption.
         */
    ...
    interface UpdateStages {
        /**
         * The stage of the  {0} allowing to specify CommonEncryptionCbcs.
         */
        interface WithCommonEncryptionCbcs {
            /**
             * Specifies commonEncryptionCbcs.
        ...
        /**
         * The stage of the  {0} allowing to specify CommonEncryptionCenc.
         */
        interface WithCommonEncryptionCenc {
            /**
             * Specifies commonEncryptionCenc.
        ...
        /**
         * The stage of the  {0} allowing to specify EnvelopeEncryption.
         */
        interface WithEnvelopeEncryption {
            /**
             * Specifies envelopeEncryption.
        ...
        /**
         * The stage of the  {0} allowing to specify NoEncryption.
         */
        interface WithNoEncryption {
            /**
             * Specifies noEncryption.
