...
class AssetImpl extends CreatableUpdatableImpl<Asset, AssetInner, AssetImpl> implements Asset, Asset.Definition, Asset.Update {
    ...
    @Override
    public AssetImpl withStorageAccountId(String storageAccountId) {
        this.inner().withStorageAccountId(storageAccountId);
        return this;
    }

    @Override
    public AssetImpl withStorageEncryptionFormat(AssetStorageEncryptionFormat storageEncryptionFormat) {
        this.inner().withStorageEncryptionFormat(storageEncryptionFormat);
        return this;
    }

    @Override
    public AssetImpl withStorageEncryptionKey(String storageEncryptionKey) {
        this.inner().withStorageEncryptionKey(storageEncryptionKey);
        return this;
    }
