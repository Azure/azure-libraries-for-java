...
public class ProvidersInner {
     ...
     */
    public ProvidersInner(Retrofit retrofit, AzureMediaServicesImpl client) {
    ...
    interface ProvidersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.Providers checkNameAvailability" })
        @POST("subscriptions/{subscriptionId}/providers/Microsoft.Media/checkNameAvailability")
        Observable<Response<ResponseBody>> checkNameAvailability(@Path("subscriptionId") String subscriptionId, @Body CheckNameAvailabilityInputInner parameters, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public EntityNameAvailabilityCheckOutputInner checkNameAvailability(CheckNameAvailabilityInputInner parameters) {
     ...
     */
    public ServiceFuture<EntityNameAvailabilityCheckOutputInner> checkNameAvailabilityAsync(CheckNameAvailabilityInputInner parameters, final ServiceCallback<EntityNameAvailabilityCheckOutputInner> serviceCallback) {
     ...
     */
    public Observable<EntityNameAvailabilityCheckOutputInner> checkNameAvailabilityAsync(CheckNameAvailabilityInputInner parameters) {
        return checkNameAvailabilityWithServiceResponseAsync(parameters).map(new Func1<ServiceResponse<EntityNameAvailabilityCheckOutputInner>, EntityNameAvailabilityCheckOutputInner>() {
            @Override
     ...
     * @return the observable to the EntityNameAvailabilityCheckOutputInner object
     */
    public Observable<ServiceResponse<EntityNameAvailabilityCheckOutputInner>> checkNameAvailabilityWithServiceResponseAsync(CheckNameAvailabilityInputInner parameters) {
