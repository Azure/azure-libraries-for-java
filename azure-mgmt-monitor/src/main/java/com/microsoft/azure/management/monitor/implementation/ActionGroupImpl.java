...
class ActionGroupImpl
    ...
    private final String EMAIL_SUFFIX = "_-EmailAction-";
    private final String SMS_SUFFIX = "_-SMSAction-";
    private final String APP_ACTION_SUFFIX = "_-AzureAppAction-";
    private final String VOICE_SUFFIX = "_-VoiceAction-";
    private final String RUNBOOK_SUFFIX = " (RB)";
    private final String LOGIC_SUFFIX = " (LA)";
    private final String FUNCTION_SUFFIX = " (F)";
    private final String WEBHOOK_SUFFIX = " (WH)";
    private final String ITSM_SUFFIX = " (ITSM)";
    ...
    public ActionGroupImpl withAutomationRunbook(String automationAccountId, String runbookName, String webhookResourceId, boolean isGlobalRunbook) {
        ...
        String compositeKey = this.actionReceiverPrefix + RUNBOOK_SUFFIX;
