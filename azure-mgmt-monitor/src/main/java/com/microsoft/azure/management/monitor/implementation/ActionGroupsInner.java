...
public class ActionGroupsInner implements InnerSupportsGet<ActionGroupResourceInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ActionGroupResourceInner> {
    ...
    interface ActionGroupsService {
        ...
        Observable<Response<ResponseBody>> update(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("actionGroupName") String actionGroupName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body ActionGroupPatchBody actionGroupPatch, @Header("User-Agent") String userAgent);
    ...
    public ActionGroupResourceInner update(String resourceGroupName, String actionGroupName) {
        return updateWithServiceResponseAsync(resourceGroupName, actionGroupName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ActionGroupResourceInner> updateAsync(String resourceGroupName, String actionGroupName, final ServiceCallback<ActionGroupResourceInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, actionGroupName), serviceCallback);
    }
     ...
     * @return the observable to the ActionGroupResourceInner object
     */
    public Observable<ActionGroupResourceInner> updateAsync(String resourceGroupName, String actionGroupName) {
        return updateWithServiceResponseAsync(resourceGroupName, actionGroupName).map(new Func1<ServiceResponse<ActionGroupResourceInner>, ActionGroupResourceInner>() {
            @Override
            public ActionGroupResourceInner call(ServiceResponse<ActionGroupResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ActionGroupResourceInner object
     */
    public Observable<ServiceResponse<ActionGroupResourceInner>> updateWithServiceResponseAsync(String resourceGroupName, String actionGroupName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        ActionGroupPatchBody actionGroupPatch = new ActionGroupPatchBody();
        actionGroupPatch.withTags(null);
        actionGroupPatch.withEnabled(null);
        return service.update(this.client.subscriptionId(), resourceGroupName, actionGroupName, apiVersion, this.client.acceptLanguage(), actionGroupPatch, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ActionGroupResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<ActionGroupResourceInner>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the ActionGroupResourceInner object if successful.
     */
    public ActionGroupResourceInner update(String resourceGroupName, String actionGroupName, Map<String, String> tags, Boolean enabled) {
        return updateWithServiceResponseAsync(resourceGroupName, actionGroupName, tags, enabled).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ActionGroupResourceInner> updateAsync(String resourceGroupName, String actionGroupName, Map<String, String> tags, Boolean enabled, final ServiceCallback<ActionGroupResourceInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, actionGroupName, tags, enabled), serviceCallback);
    }
     ...
     * @return the observable to the ActionGroupResourceInner object
     */
    public Observable<ActionGroupResourceInner> updateAsync(String resourceGroupName, String actionGroupName, Map<String, String> tags, Boolean enabled) {
        return updateWithServiceResponseAsync(resourceGroupName, actionGroupName, tags, enabled).map(new Func1<ServiceResponse<ActionGroupResourceInner>, ActionGroupResourceInner>() {
            @Override
            public ActionGroupResourceInner call(ServiceResponse<ActionGroupResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ActionGroupResourceInner object
     */
    public Observable<ServiceResponse<ActionGroupResourceInner>> updateWithServiceResponseAsync(String resourceGroupName, String actionGroupName, Map<String, String> tags, Boolean enabled) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        final String apiVersion = "2017-04-01";
        ActionGroupPatchBody actionGroupPatch = new ActionGroupPatchBody();
        actionGroupPatch.withTags(tags);
        actionGroupPatch.withEnabled(enabled);
        return service.update(this.client.subscriptionId(), resourceGroupName, actionGroupName, apiVersion, this.client.acceptLanguage(), actionGroupPatch, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ActionGroupResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<ActionGroupResourceInner>> call(Response<ResponseBody> response) {
