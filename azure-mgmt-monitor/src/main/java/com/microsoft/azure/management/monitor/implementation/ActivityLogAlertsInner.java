...
public class ActivityLogAlertsInner implements InnerSupportsGet<ActivityLogAlertResourceInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ActivityLogAlertResourceInner> {
    ...
    interface ActivityLogAlertsService {
        ...
        Observable<Response<ResponseBody>> update(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("activityLogAlertName") String activityLogAlertName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body ActivityLogAlertPatchBody activityLogAlertPatch, @Header("User-Agent") String userAgent);
    ...
    public ActivityLogAlertResourceInner update(String resourceGroupName, String activityLogAlertName) {
        return updateWithServiceResponseAsync(resourceGroupName, activityLogAlertName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ActivityLogAlertResourceInner> updateAsync(String resourceGroupName, String activityLogAlertName, final ServiceCallback<ActivityLogAlertResourceInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, activityLogAlertName), serviceCallback);
    }
     ...
     * @return the observable to the ActivityLogAlertResourceInner object
     */
    public Observable<ActivityLogAlertResourceInner> updateAsync(String resourceGroupName, String activityLogAlertName) {
        return updateWithServiceResponseAsync(resourceGroupName, activityLogAlertName).map(new Func1<ServiceResponse<ActivityLogAlertResourceInner>, ActivityLogAlertResourceInner>() {
            @Override
            public ActivityLogAlertResourceInner call(ServiceResponse<ActivityLogAlertResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ActivityLogAlertResourceInner object
     */
    public Observable<ServiceResponse<ActivityLogAlertResourceInner>> updateWithServiceResponseAsync(String resourceGroupName, String activityLogAlertName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        ActivityLogAlertPatchBody activityLogAlertPatch = new ActivityLogAlertPatchBody();
        activityLogAlertPatch.withTags(null);
        activityLogAlertPatch.withEnabled(null);
        return service.update(this.client.subscriptionId(), resourceGroupName, activityLogAlertName, apiVersion, this.client.acceptLanguage(), activityLogAlertPatch, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ActivityLogAlertResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<ActivityLogAlertResourceInner>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the ActivityLogAlertResourceInner object if successful.
     */
    public ActivityLogAlertResourceInner update(String resourceGroupName, String activityLogAlertName, Map<String, String> tags, Boolean enabled) {
        return updateWithServiceResponseAsync(resourceGroupName, activityLogAlertName, tags, enabled).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ActivityLogAlertResourceInner> updateAsync(String resourceGroupName, String activityLogAlertName, Map<String, String> tags, Boolean enabled, final ServiceCallback<ActivityLogAlertResourceInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(resourceGroupName, activityLogAlertName, tags, enabled), serviceCallback);
    }
     ...
     * @return the observable to the ActivityLogAlertResourceInner object
     */
    public Observable<ActivityLogAlertResourceInner> updateAsync(String resourceGroupName, String activityLogAlertName, Map<String, String> tags, Boolean enabled) {
        return updateWithServiceResponseAsync(resourceGroupName, activityLogAlertName, tags, enabled).map(new Func1<ServiceResponse<ActivityLogAlertResourceInner>, ActivityLogAlertResourceInner>() {
            @Override
            public ActivityLogAlertResourceInner call(ServiceResponse<ActivityLogAlertResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ActivityLogAlertResourceInner object
     */
    public Observable<ServiceResponse<ActivityLogAlertResourceInner>> updateWithServiceResponseAsync(String resourceGroupName, String activityLogAlertName, Map<String, String> tags, Boolean enabled) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        final String apiVersion = "2017-04-01";
        ActivityLogAlertPatchBody activityLogAlertPatch = new ActivityLogAlertPatchBody();
        activityLogAlertPatch.withTags(tags);
        activityLogAlertPatch.withEnabled(enabled);
        return service.update(this.client.subscriptionId(), resourceGroupName, activityLogAlertName, apiVersion, this.client.acceptLanguage(), activityLogAlertPatch, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ActivityLogAlertResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<ActivityLogAlertResourceInner>> call(Response<ResponseBody> response) {
