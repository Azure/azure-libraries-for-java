...
public class MetricBaselinesInner {
    ...
    interface MetricBaselinesService {
        ...
        Observable<Response<ResponseBody>> calculateBaseline(@Path(value = "resourceUri", encoded = true) String resourceUri, @Query("api-version") String apiVersion, @Body TimeSeriesInformationInner timeSeriesInformation, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public CalculateBaselineResponseInner calculateBaseline(String resourceUri, TimeSeriesInformationInner timeSeriesInformation) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<CalculateBaselineResponseInner> calculateBaselineAsync(String resourceUri, TimeSeriesInformationInner timeSeriesInformation, final ServiceCallback<CalculateBaselineResponseInner> serviceCallback) {
     ...
     */
    public Observable<CalculateBaselineResponseInner> calculateBaselineAsync(String resourceUri, TimeSeriesInformationInner timeSeriesInformation) {
     ...
     * @return the observable to the CalculateBaselineResponseInner object
     */
    public Observable<ServiceResponse<CalculateBaselineResponseInner>> calculateBaselineWithServiceResponseAsync(String resourceUri, TimeSeriesInformationInner timeSeriesInformation) {
        if (resourceUri == null) {
            throw new IllegalArgumentException("Parameter resourceUri is required and cannot be null.");
        }
