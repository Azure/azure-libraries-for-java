 ...
 */
public class MetricDefinitionsInnerLegacy {
     ...
     */
    public MetricDefinitionsInnerLegacy(Retrofit retrofit, MonitorManagementClientImpl client) {
    ...
    interface MetricDefinitionsService {
        ...
        @GET("{resourceUri}/metricDefinitions")
