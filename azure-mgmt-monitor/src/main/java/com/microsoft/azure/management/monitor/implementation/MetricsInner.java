...
public class MetricsInner {
    ...
    public Observable<ServiceResponse<ResponseInner>> listWithServiceResponseAsync(String resourceUri) {
        ...
        return service.list(resourceUri, timespan, interval, metric, aggregation, top, orderby, filter, resultType, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
