...
public class PeerExpressRouteCircuitConnectionsInner {
    ...
    interface PeerExpressRouteCircuitConnectionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.PeerExpressRouteCircuitConnections get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.PeerExpressRouteCircuitConnections list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.PeerExpressRouteCircuitConnections listNext" })
        @GET
