...
public class VpnLinkConnectionsInner {
    ...
    interface VpnLinkConnectionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.VpnLinkConnections listByVpnConnection" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.VpnLinkConnections listByVpnConnectionNext" })
        @GET
