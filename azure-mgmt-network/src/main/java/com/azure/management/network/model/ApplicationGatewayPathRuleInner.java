...
public class ApplicationGatewayPathRuleInner extends SubResource {
     ...
     */
    public ApplicationGatewayPathRuleInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setPaths(List<String> paths) {
        this.paths = paths;
        return this;
    }
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setBackendAddressPool(SubResource backendAddressPool) {
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setBackendHttpSettings(SubResource backendHttpSettings) {
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setRedirectConfiguration(SubResource redirectConfiguration) {
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setRewriteRuleSet(SubResource rewriteRuleSet) {
     ...
     * @return the ApplicationGatewayPathRuleInner object itself.
     */
    public ApplicationGatewayPathRuleInner setProvisioningState(String provisioningState) {
