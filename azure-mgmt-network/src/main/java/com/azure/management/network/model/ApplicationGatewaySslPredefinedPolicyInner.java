...
public class ApplicationGatewaySslPredefinedPolicyInner extends SubResource {
     ...
     */
    public ApplicationGatewaySslPredefinedPolicyInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ApplicationGatewaySslPredefinedPolicyInner object itself.
     */
    public ApplicationGatewaySslPredefinedPolicyInner setCipherSuites(List<ApplicationGatewaySslCipherSuite> cipherSuites) {
     ...
     * @return the ApplicationGatewaySslPredefinedPolicyInner object itself.
     */
    public ApplicationGatewaySslPredefinedPolicyInner setMinProtocolVersion(ApplicationGatewaySslProtocol minProtocolVersion) {
