...
public final class ExpressRouteCircuitAuthorizationsInner {
    ...
    private interface ExpressRouteCircuitAuthorizationsService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName, @PathParam("authorizationName") String authorizationName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<ExpressRouteCircuitAuthorizationInner>> createOrUpdate(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("circuitName") String circuitName, @PathParam("authorizationName") String authorizationName, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") ExpressRouteCircuitAuthorizationInner authorizationParameters, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String circuitName, String authorizationName) {
        return service.delete(this.client.getHost(), resourceGroupName, circuitName, authorizationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String circuitName, String authorizationName) {
        return deleteWithResponseAsync(resourceGroupName, circuitName, authorizationName)
    ...
    public Mono<SimpleResponse<ExpressRouteCircuitAuthorizationInner>> getWithResponseAsync(String resourceGroupName, String circuitName, String authorizationName) {
        return service.get(this.client.getHost(), resourceGroupName, circuitName, authorizationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<ExpressRouteCircuitAuthorizationInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String circuitName, String authorizationName, ExpressRouteCircuitAuthorizationInner authorizationParameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, circuitName, authorizationName, this.client.getSubscriptionId(), authorizationParameters, this.client.getApiVersion());
    }
    ...
    public Mono<ExpressRouteCircuitAuthorizationInner> createOrUpdateAsync(String resourceGroupName, String circuitName, String authorizationName, ExpressRouteCircuitAuthorizationInner authorizationParameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, circuitName, authorizationName, authorizationParameters)
            .flatMap((SimpleResponse<ExpressRouteCircuitAuthorizationInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
    ...
    public Mono<PagedResponse<ExpressRouteCircuitAuthorizationInner>> listSinglePageAsync(String resourceGroupName, String circuitName) {
        return service.list(this.client.getHost(), resourceGroupName, circuitName, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String circuitName, String authorizationName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, circuitName, authorizationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<ExpressRouteCircuitAuthorizationInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String circuitName, String authorizationName, ExpressRouteCircuitAuthorizationInner authorizationParameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, circuitName, authorizationName, this.client.getSubscriptionId(), authorizationParameters, this.client.getApiVersion());
    }
