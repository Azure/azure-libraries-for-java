...
public final class ExpressRouteCircuitListResultInner {
     ...
     */
    public List<ExpressRouteCircuitInner> getValue() {
        return this.value;
    }
     ...
     */
    public ExpressRouteCircuitListResultInner setValue(List<ExpressRouteCircuitInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitListResultInner object itself.
     */
    public ExpressRouteCircuitListResultInner setNextLink(String nextLink) {
