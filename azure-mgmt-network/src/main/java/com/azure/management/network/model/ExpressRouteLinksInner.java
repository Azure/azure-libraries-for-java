...
public final class ExpressRouteLinksInner {
    ...
    public Mono<SimpleResponse<ExpressRouteLinkInner>> getWithResponseAsync(String resourceGroupName, String expressRoutePortName, String linkName) {
        return service.get(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, linkName, this.client.getApiVersion());
    }
    ...
    public Mono<PagedResponse<ExpressRouteLinkInner>> listSinglePageAsync(String resourceGroupName, String expressRoutePortName) {
        return service.list(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
