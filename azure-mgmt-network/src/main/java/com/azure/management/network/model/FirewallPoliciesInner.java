...
public final class FirewallPoliciesInner {
    ...
    private interface FirewallPoliciesService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("firewallPolicyName") String firewallPolicyName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<FirewallPolicyInner>> createOrUpdate(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("firewallPolicyName") String firewallPolicyName, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") FirewallPolicyInner parameters, @QueryParam("api-version") String apiVersion);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<FirewallPolicyListResultInner>> listAll(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String firewallPolicyName) {
        return service.delete(this.client.getHost(), resourceGroupName, firewallPolicyName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String firewallPolicyName) {
        return deleteWithResponseAsync(resourceGroupName, firewallPolicyName)
    ...
    public Mono<SimpleResponse<FirewallPolicyInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String firewallPolicyName, String expand) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, firewallPolicyName, this.client.getSubscriptionId(), expand, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<FirewallPolicyInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String firewallPolicyName, FirewallPolicyInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, firewallPolicyName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FirewallPolicyInner>> listAllSinglePageAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<FirewallPolicyInner> listAllAsync() {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<FirewallPolicyInner> listAll() {
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String firewallPolicyName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, firewallPolicyName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<FirewallPolicyInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String firewallPolicyName, FirewallPolicyInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, firewallPolicyName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
