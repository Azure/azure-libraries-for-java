...
public final class FirewallPolicyListResultInner {
     ...
     */
    public List<FirewallPolicyInner> getValue() {
        return this.value;
    }
     ...
     */
    public FirewallPolicyListResultInner setValue(List<FirewallPolicyInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the FirewallPolicyListResultInner object itself.
     */
    public FirewallPolicyListResultInner setNextLink(String nextLink) {
