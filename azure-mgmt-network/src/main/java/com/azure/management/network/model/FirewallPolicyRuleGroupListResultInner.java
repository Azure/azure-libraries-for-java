...
public final class FirewallPolicyRuleGroupListResultInner {
     ...
     */
    public List<FirewallPolicyRuleGroupInner> getValue() {
        return this.value;
    }
     ...
     */
    public FirewallPolicyRuleGroupListResultInner setValue(List<FirewallPolicyRuleGroupInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the FirewallPolicyRuleGroupListResultInner object itself.
     */
    public FirewallPolicyRuleGroupListResultInner setNextLink(String nextLink) {
