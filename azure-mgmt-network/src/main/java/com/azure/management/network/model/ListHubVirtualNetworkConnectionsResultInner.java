...
public final class ListHubVirtualNetworkConnectionsResultInner {
     ...
     */
    public List<HubVirtualNetworkConnectionInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListHubVirtualNetworkConnectionsResultInner setValue(List<HubVirtualNetworkConnectionInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListHubVirtualNetworkConnectionsResultInner object itself.
     */
    public ListHubVirtualNetworkConnectionsResultInner setNextLink(String nextLink) {
