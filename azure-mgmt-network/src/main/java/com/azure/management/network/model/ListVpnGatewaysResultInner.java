...
public final class ListVpnGatewaysResultInner {
     ...
     */
    public List<VpnGatewayInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListVpnGatewaysResultInner setValue(List<VpnGatewayInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListVpnGatewaysResultInner object itself.
     */
    public ListVpnGatewaysResultInner setNextLink(String nextLink) {
