...
public final class ListVpnSiteLinkConnectionsResultInner {
     ...
     */
    public List<VpnSiteLinkConnectionInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListVpnSiteLinkConnectionsResultInner setValue(List<VpnSiteLinkConnectionInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListVpnSiteLinkConnectionsResultInner object itself.
     */
    public ListVpnSiteLinkConnectionsResultInner setNextLink(String nextLink) {
