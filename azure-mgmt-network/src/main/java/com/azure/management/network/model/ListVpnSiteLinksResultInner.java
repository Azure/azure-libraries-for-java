...
public final class ListVpnSiteLinksResultInner {
     ...
     */
    public List<VpnSiteLinkInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListVpnSiteLinksResultInner setValue(List<VpnSiteLinkInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListVpnSiteLinksResultInner object itself.
     */
    public ListVpnSiteLinksResultInner setNextLink(String nextLink) {
