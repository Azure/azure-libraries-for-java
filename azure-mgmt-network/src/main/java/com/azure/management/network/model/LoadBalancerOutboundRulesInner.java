...
public final class LoadBalancerOutboundRulesInner {
     ...
     * @param resourceGroupName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param loadBalancerName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param outboundRuleName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws CloudException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    ...
    public Mono<SimpleResponse<OutboundRuleInner>> getWithResponseAsync(String resourceGroupName, String loadBalancerName, String outboundRuleName) {
        return service.get(this.client.getHost(), resourceGroupName, loadBalancerName, outboundRuleName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
