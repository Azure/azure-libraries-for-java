...
public final class LoadBalancerProbesInner {
     ...
     * @param resourceGroupName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param loadBalancerName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param probeName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws CloudException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    ...
    public Mono<SimpleResponse<ProbeInner>> getWithResponseAsync(String resourceGroupName, String loadBalancerName, String probeName) {
        return service.get(this.client.getHost(), resourceGroupName, loadBalancerName, probeName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
