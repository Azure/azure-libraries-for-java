...
public final class NextHopResultInner {
     ...
     */
    public NextHopResultInner setNextHopType(NextHopType nextHopType) {
     ...
     * @return the NextHopResultInner object itself.
     */
    public NextHopResultInner setNextHopIpAddress(String nextHopIpAddress) {
     ...
     * @return the NextHopResultInner object itself.
     */
    public NextHopResultInner setRouteTableId(String routeTableId) {
