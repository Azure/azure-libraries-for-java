...
public final class PeerExpressRouteCircuitConnectionListResultInner {
     ...
     */
    public List<PeerExpressRouteCircuitConnectionInner> getValue() {
        return this.value;
    }
     ...
     * itself.
     */
    public PeerExpressRouteCircuitConnectionListResultInner setValue(List<PeerExpressRouteCircuitConnectionInner> value) {
        this.value = value;
        return this;
    }
     ...
     * itself.
     */
    public PeerExpressRouteCircuitConnectionListResultInner setNextLink(String nextLink) {
