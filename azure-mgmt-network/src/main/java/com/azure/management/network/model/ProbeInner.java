...
public class ProbeInner extends SubResource {
     ...
     */
    public ProbeInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setProtocol(ProbeProtocol protocol) {
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setPort(Integer port) {
        this.port = port;
        return this;
    }
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setIntervalInSeconds(Integer intervalInSeconds) {
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setNumberOfProbes(Integer numberOfProbes) {
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setRequestPath(String requestPath) {
     ...
     * @return the ProbeInner object itself.
     */
    public ProbeInner setProvisioningState(String provisioningState) {
