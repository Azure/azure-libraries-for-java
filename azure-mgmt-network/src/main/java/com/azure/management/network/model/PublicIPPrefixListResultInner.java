...
public final class PublicIPPrefixListResultInner {
     ...
     */
    public List<PublicIPPrefixInner> getValue() {
        return this.value;
    }
     ...
     */
    public PublicIPPrefixListResultInner setValue(List<PublicIPPrefixInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the PublicIPPrefixListResultInner object itself.
     */
    public PublicIPPrefixListResultInner setNextLink(String nextLink) {
