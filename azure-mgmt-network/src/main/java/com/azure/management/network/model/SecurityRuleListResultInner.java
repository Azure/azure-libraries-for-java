...
public final class SecurityRuleListResultInner {
     ...
     */
    public List<SecurityRuleInner> getValue() {
        return this.value;
    }
     ...
     */
    public SecurityRuleListResultInner setValue(List<SecurityRuleInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the SecurityRuleListResultInner object itself.
     */
    public SecurityRuleListResultInner setNextLink(String nextLink) {
