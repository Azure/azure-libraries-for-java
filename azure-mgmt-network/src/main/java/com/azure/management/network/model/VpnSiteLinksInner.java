...
public final class VpnSiteLinksInner {
    ...
    public Mono<SimpleResponse<VpnSiteLinkInner>> getWithResponseAsync(String resourceGroupName, String vpnSiteName, String vpnSiteLinkName) {
        return service.get(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, vpnSiteLinkName, this.client.getApiVersion());
    }
    ...
    public Mono<PagedResponse<VpnSiteLinkInner>> listByVpnSiteSinglePageAsync(String resourceGroupName, String vpnSiteName) {
        return service.listByVpnSite(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
