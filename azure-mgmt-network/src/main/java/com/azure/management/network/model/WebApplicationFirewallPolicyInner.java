...
public class WebApplicationFirewallPolicyInner extends Resource {
     ...
     */
    public WebApplicationFirewallPolicyInner setEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the WebApplicationFirewallPolicyInner object itself.
     */
    public WebApplicationFirewallPolicyInner setPolicySettings(PolicySettings policySettings) {
     ...
     * @return the WebApplicationFirewallPolicyInner object itself.
     */
    public WebApplicationFirewallPolicyInner setCustomRules(List<WebApplicationFirewallCustomRule> customRules) {
     ...
     */
    public List<ApplicationGatewayInner> getApplicationGateways() {
