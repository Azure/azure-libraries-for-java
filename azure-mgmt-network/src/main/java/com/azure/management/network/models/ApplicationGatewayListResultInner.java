...
public final class ApplicationGatewayListResultInner {
     ...
     */
    public List<ApplicationGatewayInner> getValue() {
        return this.value;
    }
     ...
     */
    public ApplicationGatewayListResultInner setValue(List<ApplicationGatewayInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ApplicationGatewayListResultInner object itself.
     */
    public ApplicationGatewayListResultInner setNextLink(String nextLink) {
