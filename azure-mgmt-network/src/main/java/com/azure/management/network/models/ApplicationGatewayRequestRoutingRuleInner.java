...
public class ApplicationGatewayRequestRoutingRuleInner extends SubResource {
     ...
     */
    public ApplicationGatewayRequestRoutingRuleInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setRuleType(ApplicationGatewayRequestRoutingRuleType ruleType) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setBackendAddressPool(SubResource backendAddressPool) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setBackendHttpSettings(SubResource backendHttpSettings) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setHttpListener(SubResource httpListener) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setUrlPathMap(SubResource urlPathMap) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setRewriteRuleSet(SubResource rewriteRuleSet) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setRedirectConfiguration(SubResource redirectConfiguration) {
     ...
     * @return the ApplicationGatewayRequestRoutingRuleInner object itself.
     */
    public ApplicationGatewayRequestRoutingRuleInner setProvisioningState(String provisioningState) {
