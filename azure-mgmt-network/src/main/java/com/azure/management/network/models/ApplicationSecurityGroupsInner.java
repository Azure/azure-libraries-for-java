...
public final class ApplicationSecurityGroupsInner implements InnerSupportsGet<ApplicationSecurityGroupInner>, InnerSupportsDelete<Void> {
    ...
    private interface ApplicationSecurityGroupsService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("applicationSecurityGroupName") String applicationSecurityGroupName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<ApplicationSecurityGroupInner>> createOrUpdate(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("applicationSecurityGroupName") String applicationSecurityGroupName, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") ApplicationSecurityGroupInner parameters, @QueryParam("api-version") String apiVersion);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<ApplicationSecurityGroupListResultInner>> listAll(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String applicationSecurityGroupName) {
        return service.delete(this.client.getHost(), resourceGroupName, applicationSecurityGroupName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String applicationSecurityGroupName) {
        return deleteWithResponseAsync(resourceGroupName, applicationSecurityGroupName)
    ...
    public Mono<SimpleResponse<ApplicationSecurityGroupInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String applicationSecurityGroupName) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, applicationSecurityGroupName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<ApplicationSecurityGroupInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String applicationSecurityGroupName, ApplicationSecurityGroupInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, applicationSecurityGroupName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
    ...
    public Mono<ApplicationSecurityGroupInner> createOrUpdateAsync(String resourceGroupName, String applicationSecurityGroupName, ApplicationSecurityGroupInner parameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, applicationSecurityGroupName, parameters)
            .flatMap((SimpleResponse<ApplicationSecurityGroupInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ApplicationSecurityGroupInner>> listAllSinglePageAsync() {
    ...
    public PagedFlux<ApplicationSecurityGroupInner> listAllAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ApplicationSecurityGroupInner> listAll() {
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String applicationSecurityGroupName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, applicationSecurityGroupName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<ApplicationSecurityGroupInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String applicationSecurityGroupName, ApplicationSecurityGroupInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, applicationSecurityGroupName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
