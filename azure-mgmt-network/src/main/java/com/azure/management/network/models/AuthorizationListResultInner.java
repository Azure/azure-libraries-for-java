...
public final class AuthorizationListResultInner {
     ...
     */
    public List<ExpressRouteCircuitAuthorizationInner> getValue() {
        return this.value;
    }
     ...
     */
    public AuthorizationListResultInner setValue(List<ExpressRouteCircuitAuthorizationInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the AuthorizationListResultInner object itself.
     */
    public AuthorizationListResultInner setNextLink(String nextLink) {
