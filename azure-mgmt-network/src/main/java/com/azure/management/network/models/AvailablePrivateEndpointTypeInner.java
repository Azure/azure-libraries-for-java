...
public final class AvailablePrivateEndpointTypeInner {
     ...
     */
    public AvailablePrivateEndpointTypeInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the AvailablePrivateEndpointTypeInner object itself.
     */
    public AvailablePrivateEndpointTypeInner setId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the AvailablePrivateEndpointTypeInner object itself.
     */
    public AvailablePrivateEndpointTypeInner setType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the AvailablePrivateEndpointTypeInner object itself.
     */
    public AvailablePrivateEndpointTypeInner setResourceName(String resourceName) {
