...
public class BastionHostInner extends Resource {
     ...
     */
    public BastionHostInner setIpConfigurations(List<BastionHostIPConfiguration> ipConfigurations) {
     ...
     * @return the BastionHostInner object itself.
     */
    public BastionHostInner setDnsName(String dnsName) {
     ...
     * @return the BastionHostInner object itself.
     */
    public BastionHostInner setProvisioningState(ProvisioningState provisioningState) {
