...
public final class BastionHostListResultInner {
     ...
     */
    public List<BastionHostInner> getValue() {
        return this.value;
    }
     ...
     */
    public BastionHostListResultInner setValue(List<BastionHostInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the BastionHostListResultInner object itself.
     */
    public BastionHostListResultInner setNextLink(String nextLink) {
