...
public final class BastionHostsInner implements InnerSupportsGet<BastionHostInner>, InnerSupportsListing<BastionHostInner>, InnerSupportsDelete<Void> {
    ...
    private interface BastionHostsService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("bastionHostName") String bastionHostName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<BastionHostInner>> createOrUpdate(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("bastionHostName") String bastionHostName, @PathParam("subscriptionId") String subscriptionId, @BodyParam("application/json") BastionHostInner parameters, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String bastionHostName) {
        return service.delete(this.client.getHost(), resourceGroupName, bastionHostName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String bastionHostName) {
        return deleteWithResponseAsync(resourceGroupName, bastionHostName)
    ...
    public Mono<SimpleResponse<BastionHostInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String bastionHostName) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, bastionHostName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<BastionHostInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String bastionHostName, BastionHostInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, bastionHostName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
    ...
    public Mono<BastionHostInner> createOrUpdateAsync(String resourceGroupName, String bastionHostName, BastionHostInner parameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, bastionHostName, parameters)
            .flatMap((SimpleResponse<BastionHostInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String bastionHostName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, bastionHostName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<BastionHostInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String bastionHostName, BastionHostInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, bastionHostName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
