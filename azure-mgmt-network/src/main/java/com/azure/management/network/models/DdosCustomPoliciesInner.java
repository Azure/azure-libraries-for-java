...
public final class DdosCustomPoliciesInner implements InnerSupportsGet<DdosCustomPolicyInner>, InnerSupportsDelete<Void> {
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName) {
        return service.delete(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<DdosCustomPolicyInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<DdosCustomPolicyInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicyInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<DdosCustomPolicyInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicyInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, ddosCustomPolicyName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
