...
public final class DdosProtectionPlansInner {
    ...
    private interface DdosProtectionPlansService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("ddosProtectionPlanName") String ddosProtectionPlanName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName) {
        return service.delete(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String ddosProtectionPlanName) {
        return deleteWithResponseAsync(resourceGroupName, ddosProtectionPlanName)
    ...
    public Mono<SimpleResponse<DdosProtectionPlanInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<DdosProtectionPlanInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName, DdosProtectionPlanInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
    ...
    public Mono<DdosProtectionPlanInner> createOrUpdateAsync(String resourceGroupName, String ddosProtectionPlanName, DdosProtectionPlanInner parameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, ddosProtectionPlanName, parameters)
            .flatMap((SimpleResponse<DdosProtectionPlanInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<DdosProtectionPlanInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String ddosProtectionPlanName, DdosProtectionPlanInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, ddosProtectionPlanName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
