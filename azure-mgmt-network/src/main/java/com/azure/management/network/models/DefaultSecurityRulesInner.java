...
public final class DefaultSecurityRulesInner {
    ...
    public Mono<SimpleResponse<SecurityRuleInner>> getWithResponseAsync(String resourceGroupName, String networkSecurityGroupName, String defaultSecurityRuleName) {
        return service.get(this.client.getHost(), resourceGroupName, networkSecurityGroupName, defaultSecurityRuleName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
