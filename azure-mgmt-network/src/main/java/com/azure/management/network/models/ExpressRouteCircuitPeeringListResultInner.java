...
public final class ExpressRouteCircuitPeeringListResultInner {
     ...
     */
    public List<ExpressRouteCircuitPeeringInner> getValue() {
        return this.value;
    }
     ...
     */
    public ExpressRouteCircuitPeeringListResultInner setValue(List<ExpressRouteCircuitPeeringInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitPeeringListResultInner object itself.
     */
    public ExpressRouteCircuitPeeringListResultInner setNextLink(String nextLink) {
