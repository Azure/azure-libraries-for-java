...
public final class ExpressRouteCircuitRoutesTableInner {
     ...
     */
    public ExpressRouteCircuitRoutesTableInner withNetwork(String network) {
     ...
     * @return the ExpressRouteCircuitRoutesTableInner object itself.
     */
    public ExpressRouteCircuitRoutesTableInner withNextHop(String nextHop) {
     ...
     * @return the ExpressRouteCircuitRoutesTableInner object itself.
     */
    public ExpressRouteCircuitRoutesTableInner withLocPrf(String locPrf) {
        this.locPrf = locPrf;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableInner object itself.
     */
    public ExpressRouteCircuitRoutesTableInner withWeight(Integer weight) {
        this.weight = weight;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableInner object itself.
     */
    public ExpressRouteCircuitRoutesTableInner withPath(String path) {
        this.path = path;
        return this;
    }
}
