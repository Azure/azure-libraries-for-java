 ...
 */
@Fluent
public final class ExpressRouteCircuitRoutesTableSummaryInner {
    /*
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner withNeighbor(String neighbor) {
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner withV(Integer v) {
        this.v = v;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner withAs(Integer as) {
        this.as = as;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner withUpDown(String upDown) {
        this.upDown = upDown;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner withStatePfxRcd(String statePfxRcd) {
