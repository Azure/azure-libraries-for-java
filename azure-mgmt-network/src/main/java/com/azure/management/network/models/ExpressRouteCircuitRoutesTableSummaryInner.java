...
public final class ExpressRouteCircuitRoutesTableSummaryInner {
     ...
     */
    public ExpressRouteCircuitRoutesTableSummaryInner setNeighbor(String neighbor) {
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner setV(Integer v) {
        this.v = v;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner setAs(Integer as) {
        this.as = as;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner setUpDown(String upDown) {
        this.upDown = upDown;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTableSummaryInner object itself.
     */
    public ExpressRouteCircuitRoutesTableSummaryInner setStatePfxRcd(String statePfxRcd) {
