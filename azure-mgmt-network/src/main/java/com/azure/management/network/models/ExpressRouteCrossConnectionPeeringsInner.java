...
public final class ExpressRouteCrossConnectionPeeringsInner {
    ...
    private interface ExpressRouteCrossConnectionPeeringsService {
        ...
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("crossConnectionName") String crossConnectionName, @PathParam("peeringName") String peeringName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<PagedResponse<ExpressRouteCrossConnectionPeeringInner>> listSinglePageAsync(String resourceGroupName, String crossConnectionName) {
        return service.list(this.client.getHost(), resourceGroupName, crossConnectionName, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String crossConnectionName, String peeringName) {
        return service.delete(this.client.getHost(), resourceGroupName, crossConnectionName, peeringName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String crossConnectionName, String peeringName) {
        return deleteWithResponseAsync(resourceGroupName, crossConnectionName, peeringName)
    ...
    public Mono<SimpleResponse<ExpressRouteCrossConnectionPeeringInner>> getWithResponseAsync(String resourceGroupName, String crossConnectionName, String peeringName) {
        return service.get(this.client.getHost(), resourceGroupName, crossConnectionName, peeringName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<ExpressRouteCrossConnectionPeeringInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String crossConnectionName, String peeringName, ExpressRouteCrossConnectionPeeringInner peeringParameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, crossConnectionName, peeringName, this.client.getSubscriptionId(), peeringParameters, this.client.getApiVersion());
    }
    ...
    public Mono<ExpressRouteCrossConnectionPeeringInner> createOrUpdateAsync(String resourceGroupName, String crossConnectionName, String peeringName, ExpressRouteCrossConnectionPeeringInner peeringParameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, crossConnectionName, peeringName, peeringParameters)
            .flatMap((SimpleResponse<ExpressRouteCrossConnectionPeeringInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String crossConnectionName, String peeringName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, crossConnectionName, peeringName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<ExpressRouteCrossConnectionPeeringInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String crossConnectionName, String peeringName, ExpressRouteCrossConnectionPeeringInner peeringParameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, crossConnectionName, peeringName, this.client.getSubscriptionId(), peeringParameters, this.client.getApiVersion());
    }
