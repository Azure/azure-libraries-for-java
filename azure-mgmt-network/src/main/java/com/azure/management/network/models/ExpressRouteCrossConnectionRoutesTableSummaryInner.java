 ...
 */
@Fluent
public final class ExpressRouteCrossConnectionRoutesTableSummaryInner {
    /*
     ...
     * @return the ExpressRouteCrossConnectionRoutesTableSummaryInner object
     * itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummaryInner withNeighbor(String neighbor) {
     ...
     * itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummaryInner withAsn(Integer asn) {
        this.asn = asn;
        return this;
    }
     ...
     * itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummaryInner withUpDown(String upDown) {
        this.upDown = upDown;
        return this;
    }
     ...
     * itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummaryInner withStateOrPrefixesReceived(String stateOrPrefixesReceived) {
