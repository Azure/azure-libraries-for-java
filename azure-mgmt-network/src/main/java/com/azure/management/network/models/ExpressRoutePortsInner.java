...
public final class ExpressRoutePortsInner implements InnerSupportsGet<ExpressRoutePortInner>, InnerSupportsListing<ExpressRoutePortInner>, InnerSupportsDelete<Void> {
    ...
    private interface ExpressRoutePortsService {
        ...
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("expressRoutePortName") String expressRoutePortName, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String expressRoutePortName) {
        return service.delete(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String expressRoutePortName) {
        return deleteWithResponseAsync(resourceGroupName, expressRoutePortName)
    ...
    public Mono<SimpleResponse<ExpressRoutePortInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String expressRoutePortName) {
        return service.getByResourceGroup(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<ExpressRoutePortInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String expressRoutePortName, ExpressRoutePortInner parameters) {
        return service.createOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, parameters, this.client.getApiVersion());
    }
    ...
    public Mono<ExpressRoutePortInner> createOrUpdateAsync(String resourceGroupName, String expressRoutePortName, ExpressRoutePortInner parameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, expressRoutePortName, parameters)
            .flatMap((SimpleResponse<ExpressRoutePortInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String expressRoutePortName) {
        return service.beginDelete(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<ExpressRoutePortInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String expressRoutePortName, ExpressRoutePortInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, expressRoutePortName, parameters, this.client.getApiVersion());
    }
