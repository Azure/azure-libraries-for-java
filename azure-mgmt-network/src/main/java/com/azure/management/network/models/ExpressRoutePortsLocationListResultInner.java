...
public final class ExpressRoutePortsLocationListResultInner {
     ...
     */
    public List<ExpressRoutePortsLocationInner> getValue() {
        return this.value;
    }
     ...
     */
    public ExpressRoutePortsLocationListResultInner setValue(List<ExpressRoutePortsLocationInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ExpressRoutePortsLocationListResultInner object itself.
     */
    public ExpressRoutePortsLocationListResultInner setNextLink(String nextLink) {
