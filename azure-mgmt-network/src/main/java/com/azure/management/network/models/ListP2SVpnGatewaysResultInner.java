...
public final class ListP2SVpnGatewaysResultInner {
     ...
     */
    public List<P2SVpnGatewayInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListP2SVpnGatewaysResultInner setValue(List<P2SVpnGatewayInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListP2SVpnGatewaysResultInner object itself.
     */
    public ListP2SVpnGatewaysResultInner setNextLink(String nextLink) {
