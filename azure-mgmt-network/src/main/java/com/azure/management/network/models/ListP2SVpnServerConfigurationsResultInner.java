...
public final class ListP2SVpnServerConfigurationsResultInner {
     ...
     */
    public List<P2SVpnServerConfigurationInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListP2SVpnServerConfigurationsResultInner setValue(List<P2SVpnServerConfigurationInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListP2SVpnServerConfigurationsResultInner object itself.
     */
    public ListP2SVpnServerConfigurationsResultInner setNextLink(String nextLink) {
