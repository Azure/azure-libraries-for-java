...
public final class ListVirtualHubsResultInner {
     ...
     */
    public List<VirtualHubInner> getValue() {
        return this.value;
    }
     ...
     */
    public ListVirtualHubsResultInner setValue(List<VirtualHubInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListVirtualHubsResultInner object itself.
     */
    public ListVirtualHubsResultInner setNextLink(String nextLink) {
