...
public final class LoadBalancerBackendAddressPoolsInner {
     ...
     * @param resourceGroupName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param loadBalancerName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param backendAddressPoolName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws CloudException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    ...
    public Mono<SimpleResponse<BackendAddressPoolInner>> getWithResponseAsync(String resourceGroupName, String loadBalancerName, String backendAddressPoolName) {
        return service.get(this.client.getHost(), resourceGroupName, loadBalancerName, backendAddressPoolName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
