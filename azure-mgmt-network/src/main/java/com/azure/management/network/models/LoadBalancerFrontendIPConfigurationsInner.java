...
public final class LoadBalancerFrontendIPConfigurationsInner {
     ...
     * @param resourceGroupName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param loadBalancerName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @param frontendIPConfigurationName MISSING·SCHEMA-DESCRIPTION-STRING.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws CloudException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    ...
    public Mono<SimpleResponse<FrontendIPConfigurationInner>> getWithResponseAsync(String resourceGroupName, String loadBalancerName, String frontendIPConfigurationName) {
        return service.get(this.client.getHost(), resourceGroupName, loadBalancerName, frontendIPConfigurationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
