...
public final class NetworkInterfaceTapConfigurationsInner {
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        return service.delete(this.client.getHost(), resourceGroupName, networkInterfaceName, tapConfigurationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<NetworkInterfaceTapConfigurationInner>> getWithResponseAsync(String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        return service.get(this.client.getHost(), resourceGroupName, networkInterfaceName, tapConfigurationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<NetworkInterfaceTapConfigurationInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String networkInterfaceName, String tapConfigurationName, NetworkInterfaceTapConfigurationInner tapConfigurationParameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, networkInterfaceName, tapConfigurationName, this.client.getSubscriptionId(), tapConfigurationParameters, this.client.getApiVersion());
    }
    ...
    public Mono<PagedResponse<NetworkInterfaceTapConfigurationInner>> listSinglePageAsync(String resourceGroupName, String networkInterfaceName) {
        return service.list(this.client.getHost(), resourceGroupName, networkInterfaceName, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, networkInterfaceName, tapConfigurationName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<NetworkInterfaceTapConfigurationInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String networkInterfaceName, String tapConfigurationName, NetworkInterfaceTapConfigurationInner tapConfigurationParameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, networkInterfaceName, tapConfigurationName, this.client.getSubscriptionId(), tapConfigurationParameters, this.client.getApiVersion());
    }
