...
public final class NetworkManagementClientImpl extends AzureServiceClient {
    ...
    public Mono<SimpleResponse<DnsNameAvailabilityResultInner>> checkDnsNameAvailabilityWithResponseAsync(String location, String domainNameLabel) {
        return service.checkDnsNameAvailability(this.client.getHost(), location, domainNameLabel, this.client.getSubscriptionId(), this.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<VirtualWanSecurityProvidersInner>> supportedSecurityProvidersWithResponseAsync(String resourceGroupName, String virtualWANName) {
        return service.supportedSecurityProviders(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, virtualWANName, this.getApiVersion());
    }
