...
public final class NetworkSecurityGroupListResultInner {
     ...
     */
    public List<NetworkSecurityGroupInner> getValue() {
        return this.value;
    }
     ...
     */
    public NetworkSecurityGroupListResultInner setValue(List<NetworkSecurityGroupInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the NetworkSecurityGroupListResultInner object itself.
     */
    public NetworkSecurityGroupListResultInner setNextLink(String nextLink) {
