...
public class P2SVpnServerConfigurationInner extends SubResource {
     ...
     */
    public P2SVpnServerConfigurationInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * P2SVpnServerConfiguration that is unique within a VirtualWan in a
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setNamePropertiesName(String namePropertiesName) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setVpnProtocols(List<VpnGatewayTunnelingProtocol> vpnProtocols) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setP2SVpnServerConfigVpnClientRootCertificates(List<P2SVpnServerConfigVpnClientRootCertificate> p2SVpnServerConfigVpnClientRootCertificates) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setP2SVpnServerConfigVpnClientRevokedCertificates(List<P2SVpnServerConfigVpnClientRevokedCertificate> p2SVpnServerConfigVpnClientRevokedCertificates) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setP2SVpnServerConfigRadiusServerRootCertificates(List<P2SVpnServerConfigRadiusServerRootCertificate> p2SVpnServerConfigRadiusServerRootCertificates) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setP2SVpnServerConfigRadiusClientRootCertificates(List<P2SVpnServerConfigRadiusClientRootCertificate> p2SVpnServerConfigRadiusClientRootCertificates) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setVpnClientIpsecPolicies(List<IpsecPolicy> vpnClientIpsecPolicies) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setRadiusServerAddress(String radiusServerAddress) {
     ...
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setRadiusServerSecret(String radiusServerSecret) {
     ...
     */
    public List<SubResource> getP2SVpnGateways() {
    ...
    /**
     * Set the etagPropertiesEtag property: A unique read-only string that
     * changes whenever the resource is updated.
     * 
     * @param etagPropertiesEtag the etagPropertiesEtag value to set.
     * @return the P2SVpnServerConfigurationInner object itself.
     */
    public P2SVpnServerConfigurationInner setEtagPropertiesEtag(String etagPropertiesEtag) {
