...
public final class PacketCaptureQueryStatusResultInner {
     ...
     */
    public PacketCaptureQueryStatusResultInner setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the PacketCaptureQueryStatusResultInner object itself.
     */
    public PacketCaptureQueryStatusResultInner setId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the PacketCaptureQueryStatusResultInner object itself.
     */
    public PacketCaptureQueryStatusResultInner setCaptureStartTime(OffsetDateTime captureStartTime) {
     ...
     * @return the PacketCaptureQueryStatusResultInner object itself.
     */
    public PacketCaptureQueryStatusResultInner setPacketCaptureStatus(PcStatus packetCaptureStatus) {
     ...
     * @return the PacketCaptureQueryStatusResultInner object itself.
     */
    public PacketCaptureQueryStatusResultInner setStopReason(String stopReason) {
     ...
     * @return the PacketCaptureQueryStatusResultInner object itself.
     */
    public PacketCaptureQueryStatusResultInner setPacketCaptureError(List<PcError> packetCaptureError) {
