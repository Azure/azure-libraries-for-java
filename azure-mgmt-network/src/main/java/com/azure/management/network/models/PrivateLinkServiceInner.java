...
public class PrivateLinkServiceInner extends Resource {
     ...
     */
    public PrivateLinkServiceInner setEtag(String etag) {
        this.etag = etag;
        return this;
    }
     ...
     */
    public List<FrontendIPConfigurationInner> getLoadBalancerFrontendIpConfigurations() {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setLoadBalancerFrontendIpConfigurations(List<FrontendIPConfigurationInner> loadBalancerFrontendIpConfigurations) {
     ...
     */
    public List<PrivateLinkServiceIpConfigurationInner> getIpConfigurations() {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setIpConfigurations(List<PrivateLinkServiceIpConfigurationInner> ipConfigurations) {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setProvisioningState(ProvisioningState provisioningState) {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setPrivateEndpointConnections(List<PrivateEndpointConnectionInner> privateEndpointConnections) {
     ...
     */
    public PrivateLinkServicePropertiesVisibility getVisibility() {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setVisibility(PrivateLinkServicePropertiesVisibility visibility) {
     ...
     */
    public PrivateLinkServicePropertiesAutoApproval getAutoApproval() {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setAutoApproval(PrivateLinkServicePropertiesAutoApproval autoApproval) {
     ...
     * @return the PrivateLinkServiceInner object itself.
     */
    public PrivateLinkServiceInner setFqdns(List<String> fqdns) {
        this.fqdns = fqdns;
        return this;
    }
