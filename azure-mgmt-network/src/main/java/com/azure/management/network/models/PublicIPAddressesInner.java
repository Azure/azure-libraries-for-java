...
public final class PublicIPAddressesInner {
    ...
    private interface PublicIPAddressesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<PublicIPAddressListResultInner>> listAll(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String publicIpAddressName) {
        return service.delete(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<PublicIPAddressInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String publicIpAddressName, String expand) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), expand, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<PublicIPAddressInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String publicIpAddressName, PublicIPAddressInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<PublicIPAddressInner>> updateTagsWithResponseAsync(String resourceGroupName, String publicIpAddressName, TagsObject parameters) {
        return service.updateTags(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PublicIPAddressInner>> listAllSinglePageAsync() {
    ...
    public PagedFlux<PublicIPAddressInner> listAllAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PublicIPAddressInner> listAll() {
    ...
    public Mono<PagedResponse<PublicIPAddressInner>> listVirtualMachineScaleSetPublicIPAddressesSinglePageAsync(String resourceGroupName, String virtualMachineScaleSetName) {
        return service.listVirtualMachineScaleSetPublicIPAddresses(this.client.getHost(), resourceGroupName, virtualMachineScaleSetName, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().getValue(),
    ...
    public Mono<PagedResponse<PublicIPAddressInner>> listVirtualMachineScaleSetVMPublicIPAddressesSinglePageAsync(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String ipConfigurationName) {
        return service.listVirtualMachineScaleSetVMPublicIPAddresses(this.client.getHost(), resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, ipConfigurationName, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().getValue(),
    ...
    public Mono<SimpleResponse<PublicIPAddressInner>> getVirtualMachineScaleSetPublicIPAddressWithResponseAsync(String resourceGroupName, String virtualMachineScaleSetName, String virtualmachineIndex, String networkInterfaceName, String ipConfigurationName, String publicIpAddressName, String expand) {
        return service.getVirtualMachineScaleSetPublicIPAddress(this.client.getHost(), resourceGroupName, virtualMachineScaleSetName, virtualmachineIndex, networkInterfaceName, ipConfigurationName, publicIpAddressName, this.client.getSubscriptionId(), expand, this.client.getApiVersion());
    }
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String publicIpAddressName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<PublicIPAddressInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String publicIpAddressName, PublicIPAddressInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<PublicIPAddressInner>> beginUpdateTagsWithResponseAsync(String resourceGroupName, String publicIpAddressName, TagsObject parameters) {
        return service.beginUpdateTags(this.client.getHost(), resourceGroupName, publicIpAddressName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PublicIPAddressInner> beginUpdateTagsAsync(String resourceGroupName, String publicIpAddressName, TagsObject parameters) {
        return beginUpdateTagsWithResponseAsync(resourceGroupName, publicIpAddressName, parameters)
            .flatMap((SimpleResponse<PublicIPAddressInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PublicIPAddressInner beginUpdateTags(String resourceGroupName, String publicIpAddressName, TagsObject parameters) {
        return beginUpdateTagsAsync(resourceGroupName, publicIpAddressName, parameters).block();
    }
