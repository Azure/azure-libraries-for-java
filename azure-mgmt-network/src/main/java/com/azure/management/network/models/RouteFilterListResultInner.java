...
public final class RouteFilterListResultInner {
     ...
     */
    public List<RouteFilterInner> getValue() {
        return this.value;
    }
     ...
     */
    public RouteFilterListResultInner setValue(List<RouteFilterInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the RouteFilterListResultInner object itself.
     */
    public RouteFilterListResultInner setNextLink(String nextLink) {
