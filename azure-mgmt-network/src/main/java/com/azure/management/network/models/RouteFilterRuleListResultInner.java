...
public final class RouteFilterRuleListResultInner {
     ...
     */
    public List<RouteFilterRuleInner> getValue() {
        return this.value;
    }
     ...
     */
    public RouteFilterRuleListResultInner setValue(List<RouteFilterRuleInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the RouteFilterRuleListResultInner object itself.
     */
    public RouteFilterRuleListResultInner setNextLink(String nextLink) {
