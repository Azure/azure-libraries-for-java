...
public final class RouteFiltersInner {
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String routeFilterName) {
        return service.delete(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<RouteFilterInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String routeFilterName, String expand) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), expand, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<RouteFilterInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String routeFilterName, RouteFilterInner routeFilterParameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), routeFilterParameters, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<RouteFilterInner>> updateWithResponseAsync(String resourceGroupName, String routeFilterName, PatchRouteFilter routeFilterParameters) {
        return service.update(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), routeFilterParameters, this.client.getApiVersion());
    }
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String routeFilterName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<RouteFilterInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String routeFilterName, RouteFilterInner routeFilterParameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), routeFilterParameters, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<RouteFilterInner>> beginUpdateWithResponseAsync(String resourceGroupName, String routeFilterName, PatchRouteFilter routeFilterParameters) {
        return service.beginUpdate(this.client.getHost(), resourceGroupName, routeFilterName, this.client.getSubscriptionId(), routeFilterParameters, this.client.getApiVersion());
    }
