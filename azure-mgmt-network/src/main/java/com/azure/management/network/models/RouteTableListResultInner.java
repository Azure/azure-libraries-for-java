...
public final class RouteTableListResultInner {
     ...
     */
    public List<RouteTableInner> getValue() {
        return this.value;
    }
     ...
     */
    public RouteTableListResultInner setValue(List<RouteTableInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the RouteTableListResultInner object itself.
     */
    public RouteTableListResultInner setNextLink(String nextLink) {
