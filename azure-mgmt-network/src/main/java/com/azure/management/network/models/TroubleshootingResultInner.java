...
public final class TroubleshootingResultInner {
     ...
     */
    public TroubleshootingResultInner setStartTime(OffsetDateTime startTime) {
     ...
     * @return the TroubleshootingResultInner object itself.
     */
    public TroubleshootingResultInner setEndTime(OffsetDateTime endTime) {
     ...
     * @return the TroubleshootingResultInner object itself.
     */
    public TroubleshootingResultInner setCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * @return the TroubleshootingResultInner object itself.
     */
    public TroubleshootingResultInner setResults(List<TroubleshootingDetails> results) {
