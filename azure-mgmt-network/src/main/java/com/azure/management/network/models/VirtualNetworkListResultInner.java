...
public final class VirtualNetworkListResultInner {
     ...
     */
    public List<VirtualNetworkInner> getValue() {
        return this.value;
    }
     ...
     */
    public VirtualNetworkListResultInner setValue(List<VirtualNetworkInner> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the VirtualNetworkListResultInner object itself.
     */
    public VirtualNetworkListResultInner setNextLink(String nextLink) {
