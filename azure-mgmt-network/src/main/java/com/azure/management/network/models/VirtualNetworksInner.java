...
public final class VirtualNetworksInner implements InnerSupportsDelete<Void> {
    ...
    private interface VirtualNetworksService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Mono<SimpleResponse<VirtualNetworkListResultInner>> listAll(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String virtualNetworkName) {
        return service.delete(this.client.getHost(), resourceGroupName, virtualNetworkName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<VirtualNetworkInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String virtualNetworkName, String expand) {
        return service.getByResourceGroup(this.client.getHost(), resourceGroupName, virtualNetworkName, this.client.getSubscriptionId(), expand, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<VirtualNetworkInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String virtualNetworkName, VirtualNetworkInner parameters) {
        return service.createOrUpdate(this.client.getHost(), resourceGroupName, virtualNetworkName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkInner>> listAllSinglePageAsync() {
    ...
    public PagedFlux<VirtualNetworkInner> listAllAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<VirtualNetworkInner> listAll() {
    ...
    public Mono<SimpleResponse<IPAddressAvailabilityResultInner>> checkIPAddressAvailabilityWithResponseAsync(String resourceGroupName, String virtualNetworkName, String ipAddress) {
        return service.checkIPAddressAvailability(this.client.getHost(), resourceGroupName, virtualNetworkName, ipAddress, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<PagedResponse<VirtualNetworkUsageInner>> listUsageSinglePageAsync(String resourceGroupName, String virtualNetworkName) {
        return service.listUsage(this.client.getHost(), resourceGroupName, virtualNetworkName, this.client.getSubscriptionId(), this.client.getApiVersion()).map(res -> new PagedResponseBase<>(
            res.getRequest(),
            res.getStatusCode(),
            res.getHeaders(),
            res.getValue().getValue(),
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String virtualNetworkName) {
        return service.beginDelete(this.client.getHost(), resourceGroupName, virtualNetworkName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<VirtualNetworkInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String virtualNetworkName, VirtualNetworkInner parameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), resourceGroupName, virtualNetworkName, this.client.getSubscriptionId(), parameters, this.client.getApiVersion());
    }
