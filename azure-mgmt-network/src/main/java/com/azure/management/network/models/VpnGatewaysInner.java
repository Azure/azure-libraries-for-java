...
public final class VpnGatewaysInner implements InnerSupportsGet<VpnGatewayInner>, InnerSupportsListing<VpnGatewayInner>, InnerSupportsDelete<Void> {
    ...
    private interface VpnGatewaysService {
        ...
        Mono<SimpleResponse<VpnGatewayInner>> reset(@HostParam("$host") String host, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("gatewayName") String gatewayName, @PathParam("subscriptionId") String subscriptionId, @QueryParam("api-version") String apiVersion);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VpnGatewayInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String gatewayName, VpnGatewayInner vpnGatewayParameters) {
        return service.createOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, gatewayName, vpnGatewayParameters, this.client.getApiVersion());
    }
    ...
    public Mono<VpnGatewayInner> createOrUpdateAsync(String resourceGroupName, String gatewayName, VpnGatewayInner vpnGatewayParameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, gatewayName, vpnGatewayParameters)
            .flatMap((SimpleResponse<VpnGatewayInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VpnGatewayInner>> resetWithResponseAsync(String resourceGroupName, String gatewayName) {
        return service.reset(this.client.getHost(), resourceGroupName, gatewayName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
    ...
    public Mono<VpnGatewayInner> resetAsync(String resourceGroupName, String gatewayName) {
        return resetWithResponseAsync(resourceGroupName, gatewayName)
            .flatMap((SimpleResponse<VpnGatewayInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
    ...
    public Mono<SimpleResponse<VpnGatewayInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String gatewayName, VpnGatewayInner vpnGatewayParameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, gatewayName, vpnGatewayParameters, this.client.getApiVersion());
    }
    ...
    public Mono<SimpleResponse<VpnGatewayInner>> beginResetWithResponseAsync(String resourceGroupName, String gatewayName) {
        return service.beginReset(this.client.getHost(), resourceGroupName, gatewayName, this.client.getSubscriptionId(), this.client.getApiVersion());
    }
