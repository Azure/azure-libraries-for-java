...
public final class VpnSitesInner {
    ...
    private interface VpnSitesService {
        ...
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<Response<Void>> delete(@HostParam("$host") String host, @PathParam("subscriptionId") String subscriptionId, @PathParam("resourceGroupName") String resourceGroupName, @PathParam("vpnSiteName") String vpnSiteName, @QueryParam("api-version") String apiVersion);
    ...
    public Mono<SimpleResponse<VpnSiteInner>> getByResourceGroupWithResponseAsync(String resourceGroupName, String vpnSiteName) {
        return service.getByResourceGroup(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VpnSiteInner>> createOrUpdateWithResponseAsync(String resourceGroupName, String vpnSiteName, VpnSiteInner vpnSiteParameters) {
        return service.createOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, vpnSiteParameters, this.client.getApiVersion());
    }
    ...
    public Mono<VpnSiteInner> createOrUpdateAsync(String resourceGroupName, String vpnSiteName, VpnSiteInner vpnSiteParameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, vpnSiteName, vpnSiteParameters)
            .flatMap((SimpleResponse<VpnSiteInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VpnSiteInner>> updateTagsWithResponseAsync(String resourceGroupName, String vpnSiteName, TagsObject vpnSiteParameters) {
        return service.updateTags(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, vpnSiteParameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> deleteWithResponseAsync(String resourceGroupName, String vpnSiteName) {
        return service.delete(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, this.client.getApiVersion());
    }
    ...
    public Mono<Void> deleteAsync(String resourceGroupName, String vpnSiteName) {
        return deleteWithResponseAsync(resourceGroupName, vpnSiteName)
    ...
    public Mono<SimpleResponse<VpnSiteInner>> beginCreateOrUpdateWithResponseAsync(String resourceGroupName, String vpnSiteName, VpnSiteInner vpnSiteParameters) {
        return service.beginCreateOrUpdate(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, vpnSiteParameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SimpleResponse<VpnSiteInner>> beginUpdateTagsWithResponseAsync(String resourceGroupName, String vpnSiteName, TagsObject vpnSiteParameters) {
        return service.beginUpdateTags(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, vpnSiteParameters, this.client.getApiVersion());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpnSiteInner> beginUpdateTagsAsync(String resourceGroupName, String vpnSiteName, TagsObject vpnSiteParameters) {
        return beginUpdateTagsWithResponseAsync(resourceGroupName, vpnSiteName, vpnSiteParameters)
            .flatMap((SimpleResponse<VpnSiteInner> res) -> {
                if (res.getValue() != null) {
                    return Mono.just(res.getValue());
                } else {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public VpnSiteInner beginUpdateTags(String resourceGroupName, String vpnSiteName, TagsObject vpnSiteParameters) {
        return beginUpdateTagsAsync(resourceGroupName, vpnSiteName, vpnSiteParameters).block();
    }
    ...
    public Mono<Response<Void>> beginDeleteWithResponseAsync(String resourceGroupName, String vpnSiteName) {
        return service.beginDelete(this.client.getHost(), this.client.getSubscriptionId(), resourceGroupName, vpnSiteName, this.client.getApiVersion());
    }
