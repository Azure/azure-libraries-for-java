 ...
 */
public class AzureReachabilityReportParametersInner {
    /**
     ...
     * @return the AzureReachabilityReportParametersInner object itself.
     */
    public AzureReachabilityReportParametersInner withProviderLocation(AzureReachabilityReportLocation providerLocation) {
     ...
     * @return the AzureReachabilityReportParametersInner object itself.
     */
    public AzureReachabilityReportParametersInner withProviders(List<String> providers) {
     ...
     * @return the AzureReachabilityReportParametersInner object itself.
     */
    public AzureReachabilityReportParametersInner withAzureLocations(List<String> azureLocations) {
     ...
     * @return the AzureReachabilityReportParametersInner object itself.
     */
    public AzureReachabilityReportParametersInner withStartTime(DateTime startTime) {
     ...
     * @return the AzureReachabilityReportParametersInner object itself.
     */
    public AzureReachabilityReportParametersInner withEndTime(DateTime endTime) {
