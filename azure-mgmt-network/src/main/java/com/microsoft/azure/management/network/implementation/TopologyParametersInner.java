 ...
 */
public class TopologyParametersInner {
    /**
     ...
     * @return the TopologyParametersInner object itself.
     */
    public TopologyParametersInner withTargetResourceGroupName(String targetResourceGroupName) {
     ...
     * @return the TopologyParametersInner object itself.
     */
    public TopologyParametersInner withTargetVirtualNetwork(SubResource targetVirtualNetwork) {
     ...
     * @return the TopologyParametersInner object itself.
     */
    public TopologyParametersInner withTargetSubnet(SubResource targetSubnet) {
