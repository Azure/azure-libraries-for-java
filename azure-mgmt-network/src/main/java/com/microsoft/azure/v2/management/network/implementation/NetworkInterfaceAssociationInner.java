 ...
 */
public final class NetworkInterfaceAssociationInner {
    /**
     ...
     * @return the NetworkInterfaceAssociationInner object itself.
     */
    public NetworkInterfaceAssociationInner withSecurityRules(List<SecurityRuleInner> securityRules) {
