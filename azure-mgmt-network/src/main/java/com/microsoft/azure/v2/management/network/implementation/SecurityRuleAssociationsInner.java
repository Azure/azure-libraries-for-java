 ...
 */
public final class SecurityRuleAssociationsInner {
    /**
     * The networkInterfaceAssociation property.
     */
    @JsonProperty(value = "networkInterfaceAssociation")
    private NetworkInterfaceAssociationInner networkInterfaceAssociation;

    /**
     * The subnetAssociation property.
     */
    @JsonProperty(value = "subnetAssociation")
    private SubnetAssociationInner subnetAssociation;
     ...
     */
    public NetworkInterfaceAssociationInner networkInterfaceAssociation() {
     ...
     * to set.
     * @return the SecurityRuleAssociationsInner object itself.
     */
    public SecurityRuleAssociationsInner withNetworkInterfaceAssociation(NetworkInterfaceAssociationInner networkInterfaceAssociation) {
     ...
     */
    public SubnetAssociationInner subnetAssociation() {
     ...
     * @return the SecurityRuleAssociationsInner object itself.
     */
    public SecurityRuleAssociationsInner withSubnetAssociation(SubnetAssociationInner subnetAssociation) {
     ...
     * @return the SecurityRuleAssociationsInner object itself.
     */
    public SecurityRuleAssociationsInner withDefaultSecurityRules(List<SecurityRuleInner> defaultSecurityRules) {
     ...
     * @return the SecurityRuleAssociationsInner object itself.
     */
    public SecurityRuleAssociationsInner withEffectiveSecurityRules(List<EffectiveNetworkSecurityRule> effectiveSecurityRules) {
