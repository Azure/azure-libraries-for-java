 ...
 */
public final class SubnetAssociationInner {
    /**
     * Subnet ID.
     */
     ...
     * @return the SubnetAssociationInner object itself.
     */
    public SubnetAssociationInner withSecurityRules(List<SecurityRuleInner> securityRules) {
