...
public class OperationsInner {
     ...
     */
    public OperationsInner(Retrofit retrofit, IotDpsClientImpl client) {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.provisioningservices.Operations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.provisioningservices.Operations listNext" })
        @GET
