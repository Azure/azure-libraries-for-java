...
public class VMwareV2FabricCreationInput extends FabricSpecificCreationInput {
     ...
     */
    public VMwareV2FabricCreationInput withKeyVaultUrl(String keyVaultUrl) {
     ...
     * @return the VMwareV2FabricCreationInput object itself.
     */
    public VMwareV2FabricCreationInput withKeyVaultResourceArmId(String keyVaultResourceArmId) {
