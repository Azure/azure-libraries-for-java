 ...
 */
public class RecoveryPlanPlannedFailoverInputPropertiesInner {
    /**
     ...
     * @return the RecoveryPlanPlannedFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanPlannedFailoverInputPropertiesInner withFailoverDirection(PossibleOperationsDirections failoverDirection) {
     ...
     * @return the RecoveryPlanPlannedFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanPlannedFailoverInputPropertiesInner withProviderSpecificDetails(List<RecoveryPlanProviderSpecificFailoverInput> providerSpecificDetails) {
