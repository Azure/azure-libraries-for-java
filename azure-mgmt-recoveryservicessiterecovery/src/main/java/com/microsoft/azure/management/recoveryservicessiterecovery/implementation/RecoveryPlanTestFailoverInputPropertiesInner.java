 ...
 */
public class RecoveryPlanTestFailoverInputPropertiesInner {
    /**
     ...
     * @return the RecoveryPlanTestFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanTestFailoverInputPropertiesInner withFailoverDirection(PossibleOperationsDirections failoverDirection) {
     ...
     * @return the RecoveryPlanTestFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanTestFailoverInputPropertiesInner withNetworkType(String networkType) {
     ...
     * @return the RecoveryPlanTestFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanTestFailoverInputPropertiesInner withNetworkId(String networkId) {
     ...
     * @return the RecoveryPlanTestFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanTestFailoverInputPropertiesInner withSkipTestFailoverCleanup(String skipTestFailoverCleanup) {
     ...
     * @return the RecoveryPlanTestFailoverInputPropertiesInner object itself.
     */
    public RecoveryPlanTestFailoverInputPropertiesInner withProviderSpecificDetails(List<RecoveryPlanProviderSpecificFailoverInput> providerSpecificDetails) {
