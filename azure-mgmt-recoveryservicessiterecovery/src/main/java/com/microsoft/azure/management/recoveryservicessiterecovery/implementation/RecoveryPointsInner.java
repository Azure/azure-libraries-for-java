...
public class RecoveryPointsInner {
    ...
    interface RecoveryPointsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.RecoveryPoints listByReplicationProtectedItems" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.RecoveryPoints get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.RecoveryPoints listByReplicationProtectedItemsNext" })
        @GET
