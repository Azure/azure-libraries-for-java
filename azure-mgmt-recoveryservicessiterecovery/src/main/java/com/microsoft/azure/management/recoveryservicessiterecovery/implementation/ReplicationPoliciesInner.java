...
import com.microsoft.azure.management.recoveryservicessiterecovery.CreatePolicyInput;
import com.microsoft.azure.management.recoveryservicessiterecovery.UpdatePolicyInput;
...
public class ReplicationPoliciesInner {
    ...
    interface ReplicationPoliciesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies beginCreate" })
        @PUT("Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationPolicies/{policyName}")
        Observable<Response<ResponseBody>> beginCreate(@Path("resourceName") String resourceName, @Path("resourceGroupName") String resourceGroupName, @Path("subscriptionId") String subscriptionId, @Path("policyName") String policyName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body CreatePolicyInput input, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies beginDelete" })
        @HTTP(path = "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationPolicies/{policyName}", method = "DELETE", hasBody = true)
        Observable<Response<ResponseBody>> beginDelete(@Path("resourceName") String resourceName, @Path("resourceGroupName") String resourceGroupName, @Path("subscriptionId") String subscriptionId, @Path("policyName") String policyName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies beginUpdate" })
        @PATCH("Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationPolicies/{policyName}")
        Observable<Response<ResponseBody>> beginUpdate(@Path("resourceName") String resourceName, @Path("resourceGroupName") String resourceGroupName, @Path("subscriptionId") String subscriptionId, @Path("policyName") String policyName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body UpdatePolicyInput input, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationPolicies listNext" })
        @GET
    ...
    public Observable<ServiceResponse<PolicyInner>> createWithServiceResponseAsync(String policyName) {
        ...
        final CreatePolicyInputPropertiesInner properties = null;
     ...
     * @return the PolicyInner object if successful.
     */
    public PolicyInner create(String policyName, CreatePolicyInputPropertiesInner properties) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PolicyInner> createAsync(String policyName, CreatePolicyInputPropertiesInner properties, final ServiceCallback<PolicyInner> serviceCallback) {
     ...
     * @return the observable for the request
     */
    public Observable<PolicyInner> createAsync(String policyName, CreatePolicyInputPropertiesInner properties) {
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<PolicyInner>> createWithServiceResponseAsync(String policyName, CreatePolicyInputPropertiesInner properties) {
        if (this.client.resourceName() == null) {
            throw new IllegalArgumentException("Parameter this.client.resourceName() is required and cannot be null.");
        }
        if (this.client.resourceGroupName() == null) {
     ...
     * @return the PolicyInner object if successful.
     */
    public PolicyInner beginCreate(String policyName, CreatePolicyInputPropertiesInner properties) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PolicyInner> beginCreateAsync(String policyName, CreatePolicyInputPropertiesInner properties, final ServiceCallback<PolicyInner> serviceCallback) {
     ...
     * @return the observable to the PolicyInner object
     */
    public Observable<PolicyInner> beginCreateAsync(String policyName, CreatePolicyInputPropertiesInner properties) {
     ...
     * @return the observable to the PolicyInner object
     */
    public Observable<ServiceResponse<PolicyInner>> beginCreateWithServiceResponseAsync(String policyName, CreatePolicyInputPropertiesInner properties) {
        if (this.client.resourceName() == null) {
            throw new IllegalArgumentException("Parameter this.client.resourceName() is required and cannot be null.");
        }
        if (this.client.resourceGroupName() == null) {
    ...
    public Observable<ServiceResponse<PolicyInner>> updateWithServiceResponseAsync(String policyName) {
        ...
        final UpdatePolicyInputPropertiesInner properties = null;
     ...
     * @return the PolicyInner object if successful.
     */
    public PolicyInner update(String policyName, UpdatePolicyInputPropertiesInner properties) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PolicyInner> updateAsync(String policyName, UpdatePolicyInputPropertiesInner properties, final ServiceCallback<PolicyInner> serviceCallback) {
     ...
     * @return the observable for the request
     */
    public Observable<PolicyInner> updateAsync(String policyName, UpdatePolicyInputPropertiesInner properties) {
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<PolicyInner>> updateWithServiceResponseAsync(String policyName, UpdatePolicyInputPropertiesInner properties) {
        if (this.client.resourceName() == null) {
            throw new IllegalArgumentException("Parameter this.client.resourceName() is required and cannot be null.");
        }
        if (this.client.resourceGroupName() == null) {
     ...
     * @return the PolicyInner object if successful.
     */
    public PolicyInner beginUpdate(String policyName, UpdatePolicyInputPropertiesInner properties) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PolicyInner> beginUpdateAsync(String policyName, UpdatePolicyInputPropertiesInner properties, final ServiceCallback<PolicyInner> serviceCallback) {
     ...
     * @return the observable to the PolicyInner object
     */
    public Observable<PolicyInner> beginUpdateAsync(String policyName, UpdatePolicyInputPropertiesInner properties) {
     ...
     * @return the observable to the PolicyInner object
     */
    public Observable<ServiceResponse<PolicyInner>> beginUpdateWithServiceResponseAsync(String policyName, UpdatePolicyInputPropertiesInner properties) {
        if (this.client.resourceName() == null) {
            throw new IllegalArgumentException("Parameter this.client.resourceName() is required and cannot be null.");
        }
        if (this.client.resourceGroupName() == null) {
