...
public class ReplicationStorageClassificationsInner {
    ...
    interface ReplicationStorageClassificationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationStorageClassifications listByReplicationFabrics" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationStorageClassifications get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationStorageClassifications list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationStorageClassifications listByReplicationFabricsNext" })
        @GET
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservicessiterecovery.ReplicationStorageClassifications listNext" })
        @GET
