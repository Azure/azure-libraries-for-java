...
public class ResourceManagementClientImpl extends AzureServiceClient {
     ...
     */
    public ResourceManagementClientImpl(TokenCredential credentials) {
     ...
     * @param credentials the management credentials for Azure
     */
    public ResourceManagementClientImpl(String baseUrl, TokenCredential credentials) {
    ...
    protected void initialize() {
        ...
        this.operations = new OperationsInner(restClient().getHttpPipeline(), this);
        this.deployments = new DeploymentsInner(restClient().getHttpPipeline(), this);
        this.providers = new ProvidersInner(restClient().getHttpPipeline(), this);
        this.resources = new ResourcesInner(restClient().getHttpPipeline(), this);
        this.resourceGroups = new ResourceGroupsInner(restClient().getHttpPipeline(), this);
        this.tags = new TagsInner(restClient().getHttpPipeline(), this);
        this.deploymentOperations = new DeploymentOperationsInner(restClient().getHttpPipeline(), this);
