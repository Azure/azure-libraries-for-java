...
public class DatabaseThreatDetectionPoliciesInner {
    ...
    interface DatabaseThreatDetectionPoliciesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.DatabaseThreatDetectionPolicies get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.DatabaseThreatDetectionPolicies createOrUpdate" })
