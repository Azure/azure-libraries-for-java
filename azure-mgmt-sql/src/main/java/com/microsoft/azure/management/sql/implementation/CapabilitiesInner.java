...
import com.microsoft.azure.management.sql.CapabilityGroup;
...
public class CapabilitiesInner {
    ...
    public Observable<ServiceResponse<LocationCapabilitiesInner>> listByLocationWithServiceResponseAsync(String locationName) {
        ...
        return service.listByLocation(locationName, this.client.subscriptionId(), include, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
