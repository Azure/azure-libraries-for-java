...
public class EncryptionProtectorsInner {
    ...
    interface EncryptionProtectorsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors revalidate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors beginRevalidate" })
        @POST("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/encryptionProtector/{encryptionProtectorName}/revalidate")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors listByServer" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors beginCreateOrUpdate" })
        @PUT("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/encryptionProtector/{encryptionProtectorName}")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.EncryptionProtectors listByServerNext" })
        @GET
    ...
    public Observable<ServiceResponse<Void>> revalidateWithServiceResponseAsync(String resourceGroupName, String serverName) {
        ...
        Observable<Response<ResponseBody>> observable = service.revalidate(resourceGroupName, serverName, encryptionProtectorName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent());
    ...
    public Observable<ServiceResponse<Void>> beginRevalidateWithServiceResponseAsync(String resourceGroupName, String serverName) {
        ...
        final String encryptionProtectorName = "current";
        final String apiVersion = "2015-05-01-preview";
        return service.beginRevalidate(resourceGroupName, serverName, encryptionProtectorName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent())
