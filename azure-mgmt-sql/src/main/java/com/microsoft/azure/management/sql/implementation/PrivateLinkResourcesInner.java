...
public class PrivateLinkResourcesInner {
     ...
     */
    public PrivateLinkResourcesInner(Retrofit retrofit, SqlManagementClientImpl client) {
    ...
    interface PrivateLinkResourcesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.PrivateLinkResources listByServer" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.PrivateLinkResources get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.PrivateLinkResources listByServerNext" })
        @GET
     ...
     * Gets the private link resources for SQL server.
     *
    ServiceResponse<PageImpl1<PrivateLinkResourceInner>> * @param resourceGroupName The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
