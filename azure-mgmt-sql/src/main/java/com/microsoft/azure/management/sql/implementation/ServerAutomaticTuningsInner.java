...
public class ServerAutomaticTuningsInner {
    ...
    interface ServerAutomaticTuningsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.ServerAutomaticTunings get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.ServerAutomaticTunings update" })
