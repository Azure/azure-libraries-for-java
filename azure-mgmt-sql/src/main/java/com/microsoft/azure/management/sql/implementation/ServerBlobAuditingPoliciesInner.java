...
public class ServerBlobAuditingPoliciesInner {
    ...
    interface ServerBlobAuditingPoliciesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.ServerBlobAuditingPolicies listByServer" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.ServerBlobAuditingPolicies listByServerNext" })
        @GET
     ...
     * Lists auditing settings of a server.
     *
    ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> * @param resourceGroupName The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.
    ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> * @param serverName The name of the server.
     * @throws IllegalArgumentException thrown if parameters fail the validation
        ...
        return service.listByServer(resourceGroupName, serverName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ServerBlobAuditingPolicyInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<ServerBlobAuditingPolicyInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> result = listByServerDelegate(response);
    ...
    private ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> listByServerDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl1<ServerBlobAuditingPolicyInner>, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl1<ServerBlobAuditingPolicyInner>>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
    }
     ...
     * Lists auditing settings of a server.
     *
    ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> * @param nextPageLink The NextLink from the previous successful call to List operation.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;ServerBlobAuditingPolicyInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<ServerBlobAuditingPolicyInner>>> listByServerNextSinglePageAsync(final String nextPageLink) {
        ...
        return service.listByServerNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ServerBlobAuditingPolicyInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<ServerBlobAuditingPolicyInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> result = listByServerNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<ServerBlobAuditingPolicyInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl1<ServerBlobAuditingPolicyInner>> listByServerNextDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl1<ServerBlobAuditingPolicyInner>, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl1<ServerBlobAuditingPolicyInner>>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
