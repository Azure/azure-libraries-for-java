...
public class ServiceTierAdvisorsInner {
    ...
    interface ServiceTierAdvisorsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.ServiceTierAdvisors get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.ServiceTierAdvisors listByDatabase" })
