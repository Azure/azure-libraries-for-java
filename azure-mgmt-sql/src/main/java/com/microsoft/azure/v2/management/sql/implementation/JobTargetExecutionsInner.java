...
public final class JobTargetExecutionsInner {
    ...
    public JobTargetExecutionsInner(SqlManagementClientImpl client) {
        this.service = AzureProxy.create(JobTargetExecutionsService.class, client);
        this.client = client;
    }
    ...
    private interface JobTargetExecutionsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(CloudException.class)
        Single<BodyResponse<PageImpl1<JobExecutionInner>>> listByStepNext(@PathParam(value = "nextUrl", encoded = true) String nextUrl, @HeaderParam("accept-language") String acceptLanguage);
    }
     ...
     * @return the PagedList&lt;JobExecutionInner&gt; object if successful.
     */
    public PagedList<JobExecutionInner> listByStep(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName) {
        Page<JobExecutionInner> response = listByStepSinglePageAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName).blockingGet();
        return new PagedList<JobExecutionInner>(response) {
            @Override
            public Page<JobExecutionInner> nextPage(String nextPageLink) {
                return listByStepNextSinglePageAsync(nextPageLink).blockingGet();
            }
        };
    }
     ...
     * @return the observable to the PagedList&lt;JobExecutionInner&gt; object.
     */
    public Observable<Page<JobExecutionInner>> listByStepAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName) {
        return listByStepSinglePageAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName)
            ...
            .concatMap((Page<JobExecutionInner> page) -> {
                ...
                return Observable.just(page).concatWith(listByStepNextAsync(nextPageLink));
            });
    }
     ...
     * @return the Single&lt;Page&lt;JobExecutionInner&gt;&gt; object if successful.
     */
    public Single<Page<JobExecutionInner>> listByStepSinglePageAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serverName == null) {
        ...
        final Integer skip = null;
        final Integer top = null;
        return service.listByStep(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, this.client.subscriptionId(), createTimeMin, createTimeMax, endTimeMin, endTimeMax, isActive, skip, top, apiVersion, this.client.acceptLanguage())
            .map((BodyResponse<PageImpl1<JobExecutionInner>> res) -> res.body());
    }
     ...
     * @return the PagedList&lt;JobExecutionInner&gt; object if successful.
     */
    public PagedList<JobExecutionInner> listByStep(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, OffsetDateTime createTimeMin, OffsetDateTime createTimeMax, OffsetDateTime endTimeMin, OffsetDateTime endTimeMax, Boolean isActive, Integer skip, Integer top) {
        Page<JobExecutionInner> response = listByStepSinglePageAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, createTimeMin, createTimeMax, endTimeMin, endTimeMax, isActive, skip, top).blockingGet();
        return new PagedList<JobExecutionInner>(response) {
            @Override
            public Page<JobExecutionInner> nextPage(String nextPageLink) {
                return listByStepNextSinglePageAsync(nextPageLink).blockingGet();
     ...
     * @return the observable to the PagedList&lt;JobExecutionInner&gt; object.
     */
    public Observable<Page<JobExecutionInner>> listByStepAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, OffsetDateTime createTimeMin, OffsetDateTime createTimeMax, OffsetDateTime endTimeMin, OffsetDateTime endTimeMax, Boolean isActive, Integer skip, Integer top) {
     ...
     * @return the Single&lt;Page&lt;JobExecutionInner&gt;&gt; object if successful.
     */
    public Single<Page<JobExecutionInner>> listByStepSinglePageAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, OffsetDateTime createTimeMin, OffsetDateTime createTimeMax, OffsetDateTime endTimeMin, OffsetDateTime endTimeMax, Boolean isActive, Integer skip, Integer top) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serverName == null) {
     ...
     */
    public JobExecutionInner get(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, @NonNull UUID targetId) {
        return getAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, targetId).blockingGet();
    }
     ...
     */
    public ServiceFuture<JobExecutionInner> getAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, @NonNull UUID targetId, ServiceCallback<JobExecutionInner> serviceCallback) {
        return ServiceFuture.fromBody(getAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, targetId), serviceCallback);
    }
     ...
     */
    public Single<BodyResponse<JobExecutionInner>> getWithRestResponseAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, @NonNull UUID targetId) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (serverName == null) {
        ...
        final String apiVersion = "2017-03-01-preview";
        return service.get(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, targetId, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage());
    }
     ...
     * @return a Single which performs the network request upon subscription.
     */
    public Maybe<JobExecutionInner> getAsync(@NonNull String resourceGroupName, @NonNull String serverName, @NonNull String jobAgentName, @NonNull String jobName, @NonNull UUID jobExecutionId, @NonNull String stepName, @NonNull UUID targetId) {
        return getWithRestResponseAsync(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, targetId)
     ...
     * @return the PagedList&lt;JobExecutionInner&gt; object if successful.
     */
    public PagedList<JobExecutionInner> listByStepNext(@NonNull String nextPageLink) {
        Page<JobExecutionInner> response = listByStepNextSinglePageAsync(nextPageLink).blockingGet();
        return new PagedList<JobExecutionInner>(response) {
            @Override
            public Page<JobExecutionInner> nextPage(String nextPageLink) {
                return listByStepNextSinglePageAsync(nextPageLink).blockingGet();
     ...
     * @return the observable to the PagedList&lt;JobExecutionInner&gt; object.
     */
    public Observable<Page<JobExecutionInner>> listByStepNextAsync(@NonNull String nextPageLink) {
        return listByStepNextSinglePageAsync(nextPageLink)
            ...
            .concatMap((Page<JobExecutionInner> page) -> {
                ...
                return Observable.just(page).concatWith(listByStepNextAsync(nextPageLink1));
            });
    }
     ...
     * @return the Single&lt;Page&lt;JobExecutionInner&gt;&gt; object if successful.
     */
    public Single<Page<JobExecutionInner>> listByStepNextSinglePageAsync(@NonNull String nextPageLink) {
        if (nextPageLink == null) {
            throw new IllegalArgumentException("Parameter nextPageLink is required and cannot be null.");
        }
        String nextUrl = String.format("%s", nextPageLink);
        return service.listByStepNext(nextUrl, this.client.acceptLanguage())
            .map((BodyResponse<PageImpl1<JobExecutionInner>> res) -> res.body());
    }
}
