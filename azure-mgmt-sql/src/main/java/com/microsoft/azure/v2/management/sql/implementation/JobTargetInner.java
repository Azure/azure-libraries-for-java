...
import com.microsoft.azure.v2.management.sql.JobTargetGroupMembershipType;
import com.microsoft.azure.v2.management.sql.JobTargetType;
...
public class JobTargetInner {
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withMembershipType(JobTargetGroupMembershipType membershipType) {
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withType(JobTargetType type) {
        this.type = type;
        return this;
    }
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withServerName(String serverName) {
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withDatabaseName(String databaseName) {
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withElasticPoolName(String elasticPoolName) {
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withShardMapName(String shardMapName) {
     ...
     * @return the JobTargetInner object itself.
     */
    public JobTargetInner withRefreshCredential(String refreshCredential) {
