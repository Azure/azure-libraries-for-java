...
public class ManagedDatabaseUpdateInner {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withCollation(String collation) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withRestorePointInTime(DateTime restorePointInTime) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withCatalogCollation(CatalogCollationType catalogCollation) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withCreateMode(ManagedDatabaseCreateMode createMode) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withStorageContainerUri(String storageContainerUri) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withSourceDatabaseId(String sourceDatabaseId) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withStorageContainerSasToken(String storageContainerSasToken) {
     ...
     * @return the ManagedDatabaseUpdateInner object itself.
     */
    public ManagedDatabaseUpdateInner withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
