...
public class RestorableDroppedDatabasesInner {
    ...
    interface RestorableDroppedDatabasesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.v2.management.sql.RestorableDroppedDatabases get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.v2.management.sql.RestorableDroppedDatabases listByServer" })
