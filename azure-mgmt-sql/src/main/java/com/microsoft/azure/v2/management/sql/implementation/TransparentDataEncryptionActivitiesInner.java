...
public class TransparentDataEncryptionActivitiesInner {
    ...
    interface TransparentDataEncryptionActivitiesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.v2.management.sql.TransparentDataEncryptionActivities listByConfiguration" })
    ...
    public Observable<ServiceResponse<List<TransparentDataEncryptionActivityInner>>> listByConfigurationWithServiceResponseAsync(String resourceGroupName, String serverName, String databaseName) {
        ...
        return service.listByConfiguration(this.client.subscriptionId(), resourceGroupName, serverName, databaseName, transparentDataEncryptionName, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
