...
public class BlobServicesInner {
    ...
    interface BlobServicesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: BlobServices list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: BlobServices setServiceProperties" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: BlobServices getServiceProperties" })
