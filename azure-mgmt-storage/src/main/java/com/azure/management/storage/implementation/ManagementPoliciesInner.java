...
public class ManagementPoliciesInner implements InnerSupportsDelete<Void> {
    ...
    interface ManagementPoliciesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: ManagementPolicies get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: ManagementPolicies createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: ManagementPolicies delete" })
