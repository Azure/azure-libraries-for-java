...
public class StorageAccountsInner implements InnerSupportsGet<StorageAccountInner>, InnerSupportsDelete<Void>, InnerSupportsListing<StorageAccountInner> {
    ...
    interface StorageAccountsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts listAccountSAS" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts listServiceSAS" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts failover" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts beginFailover" })
        @POST("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/failover")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts revokeUserDelegationKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: StorageAccounts listNext" })
        @GET
