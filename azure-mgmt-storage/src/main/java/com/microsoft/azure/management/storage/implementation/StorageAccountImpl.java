...
class StorageAccountImpl
    ...
    @Override
    public String implicitManagedServiceIdentityTenantId() {
    ...
    @Override
    public String implicitManagedServiceIdentityPrincipalId() {
        if (this.inner().identity() == null) {
            return null;
        } else {
    ...
    @Override
    public StorageAccountImpl withImplicitManagedServiceIdentity() {
        if (this.inner().identity() == null) {
            if (isInCreateMode()) {
    ...
    @Override
    public StorageAccountImpl withReadAccessToLoggingFromAnyNetwork() {
