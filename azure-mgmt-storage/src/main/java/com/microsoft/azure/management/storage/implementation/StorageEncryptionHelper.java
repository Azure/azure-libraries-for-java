...
final class StorageEncryptionHelper {
    ...
    /**
     * Specifies that encryption should be disabled for storage blob.
     *
     * @return StorageEncryptionHelper
     */
    StorageEncryptionHelper withoutBlobEncryption() {
        Encryption encryption = getEncryptionConfig(false);
        if (encryption == null || encryption.services() == null) {
            return this;
        }
        if (encryption.services().blob() == null) {
            return this;
    ...
    StorageEncryptionHelper withoutFileEncryption() {
        ...
        // Disable encryption for file service
        //
        ...
        if (isInCreateMode) {
            ...
            if (this.updateParameters.encryption() == null) {
                if (this.inner.encryption() == null) {
                    ...
                    // Create clone of current encryption
                    //
