...
import com.microsoft.azure.v2.management.storage.StorageAccount.Update;
import com.microsoft.azure.v2.management.storage.implementation.AccountStatuses;
import com.microsoft.azure.v2.management.storage.implementation.StorageAccountInner;
...
public interface StorageAccount extends
     ...
     */
    Maybe<List<StorageAccountKey>> getKeysAsync();
     ...
     */
    Maybe<List<StorageAccountKey>> regenerateKeyAsync(String keyName);
