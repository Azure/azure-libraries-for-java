...
import com.microsoft.azure.v2.management.trafficmanager.ProfileMonitorStatus;
...
class TrafficManagerProfileImpl
    ...
    @Override
    public Maybe<TrafficManagerProfile> refreshAsync() {
    ...
    @Override
    protected Maybe<ProfileInner> getInnerAsync() {
    ...
    public Completable afterPostRunAsync(final boolean isGroupFaulted) {
        ...
        if (isGroupFaulted) {
            ...
            return this.refreshAsync().flatMapCompletable(p -> Completable.complete());
        }
    }
