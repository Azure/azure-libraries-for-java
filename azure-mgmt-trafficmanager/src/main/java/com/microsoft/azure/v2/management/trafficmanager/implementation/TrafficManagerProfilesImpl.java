...
import com.microsoft.azure.v2.management.trafficmanager.CheckProfileDnsNameAvailabilityResult;
...
import com.microsoft.azure.v2.management.trafficmanager.GeographicHierarchies;
...
class TrafficManagerProfilesImpl
    ...
    public CheckProfileDnsNameAvailabilityResult checkDnsNameAvailability(String dnsNameLabel) {
        return this.checkDnsNameAvailabilityAsync(dnsNameLabel).blockingGet();
    }

    @Override
    public Maybe<CheckProfileDnsNameAvailabilityResult> checkDnsNameAvailabilityAsync(String dnsNameLabel) {
    ...
    private TrafficManagerProfileImpl setDefaults(TrafficManagerProfileImpl profile) {
        ...
        profile.inner().withEndpointsProperty(new ArrayList<EndpointInner>());
        return profile;
    }
}
