 ...
 */
@JsonFlatten
public class AppServicePlanPatchResourceInner extends ProxyOnlyResource {
    /**
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withAppServicePlanPatchResourceName(String appServicePlanPatchResourceName) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withWorkerTierName(String workerTierName) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withAdminSiteName(String adminSiteName) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withHostingEnvironmentProfile(HostingEnvironmentProfile hostingEnvironmentProfile) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withPerSiteScaling(Boolean perSiteScaling) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withIsSpot(Boolean isSpot) {
        this.isSpot = isSpot;
        return this;
    }
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withSpotExpirationTime(DateTime spotExpirationTime) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withReserved(Boolean reserved) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withTargetWorkerCount(Integer targetWorkerCount) {
     ...
     * @return the AppServicePlanPatchResourceInner object itself.
     */
    public AppServicePlanPatchResourceInner withTargetWorkerSizeId(Integer targetWorkerSizeId) {
