 ...
 */
@JsonFlatten
public class CertificatePatchResourceInner extends ProxyOnlyResource {
    /**
     ...
     * @return the CertificatePatchResourceInner object itself.
     */
    public CertificatePatchResourceInner withHostNames(List<String> hostNames) {
     ...
     * @return the CertificatePatchResourceInner object itself.
     */
    public CertificatePatchResourceInner withPfxBlob(byte[] pfxBlob) {
     ...
     * @return the CertificatePatchResourceInner object itself.
     */
    public CertificatePatchResourceInner withPassword(String password) {
     ...
     * @return the CertificatePatchResourceInner object itself.
     */
    public CertificatePatchResourceInner withKeyVaultId(String keyVaultId) {
     ...
     * @return the CertificatePatchResourceInner object itself.
     */
    public CertificatePatchResourceInner withKeyVaultSecretName(String keyVaultSecretName) {
     ...
     * @return the CertificatePatchResourceInner object itself.
     */
    public CertificatePatchResourceInner withServerFarmId(String serverFarmId) {
