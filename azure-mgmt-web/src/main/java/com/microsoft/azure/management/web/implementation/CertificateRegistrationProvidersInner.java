...
public class CertificateRegistrationProvidersInner {
    ...
    interface CertificateRegistrationProvidersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.CertificateRegistrationProviders listOperations" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.CertificateRegistrationProviders listOperationsNext" })
        @GET
