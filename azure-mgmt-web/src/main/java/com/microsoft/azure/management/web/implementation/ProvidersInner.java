...
public class ProvidersInner {
    ...
    interface ProvidersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.Providers getAvailableStacks" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.Providers listOperations" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.Providers list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.Providers getAvailableStacksNext" })
        @GET
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.Providers listOperationsNext" })
        @GET
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.Providers listNext" })
        @GET
    ...
    public Observable<ServiceResponse<Page<ApplicationStackInner>>> getAvailableStacksSinglePageAsync() {
        ...
        return service.getAvailableStacks(osTypeSelected, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
    ...
    private ServiceResponse<PageImpl<ApplicationStackInner>> getAvailableStacksDelegate(Response<ResponseBody> response) throws CloudException, IOException {
    ...
    public Observable<ServiceResponse<Page<ApplicationStackInner>>> listSinglePageAsync() {
        ...
        final String apiVersion = "2016-03-01";
        final String osTypeSelected = null;
        return service.list(this.client.subscriptionId(), osTypeSelected, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ApplicationStackInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<ApplicationStackInner>>> call(Response<ResponseBody> response) {
                    try {
