...
public class ManageLinuxFunctionAppSourceControl {
    ...
    private static String FUNCTION_APP_PACKAGE_URL = "https://raw.github.com/Azure/azure-libraries-for-java/master/azure-mgmt-appservice/src/test/resources/java-functions.zip";
    private static long TIMEOUT_IN_SECONDS = 5 * 60;
