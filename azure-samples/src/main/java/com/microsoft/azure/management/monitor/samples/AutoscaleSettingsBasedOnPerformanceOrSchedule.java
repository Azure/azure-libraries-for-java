            ...
            AutoscaleSetting scaleSettings = azure.autoscaleSettings().define(autoscaleSettingsName)
                    ...
                    .defineAutoscaleProfile("Monday to Friday")
                        ...
                        .defineScaleRule()
                            ...
                            .withStatistic(Period.minutes(5), Period.minutes(1), MetricStatisticType.SUM)
                            .withCondition(ComparisonOperationType.GREATER_THAN, TimeAggregationType.TOTAL, 10)
                        ...
                        .defineScaleRule()
                            ...
                            .withCondition(ComparisonOperationType.LESS_THAN, TimeAggregationType.TOTAL, 5)
