 ...
 * license information.
 */
package com.microsoft.azure.v2.management.graphrbac.samples;
        ...
        try {
            ...
            ServicePrincipal servicePrincipal = authenticated.servicePrincipals()
                    ...
                    .defineCertificateCredential(certName1)
                        ...
                        .withPublicKey(Files.readAllBytes(Paths.get(ManageServicePrincipalCredentials.class.getResource("/myTest.cer").toURI())))
            ...
            testCredential = new ApplicationTokenCredentials(
                    ...
                    Files.readAllBytes(Paths.get(ManageServicePrincipalCredentials.class.getResource("/myTest.pfx").toURI())),
                    "Abc123",
                    environment);
            try {
                Azure.authenticate(testCredential).withDefaultSubscription();
