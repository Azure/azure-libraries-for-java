...
//
//        for (com.microsoft.azure.v2.management.cosmosdb.Location writeReplica : cosmosDBAccount.writableReplications()) {
//            builder.append("\n\t\tWrite replication: ")
//                    .append("\n\t\t\tName :").append(writeReplica.locationName());
//        }
//
//        builder.append("\n\tNumber of read replications: ").append(cosmosDBAccount.readableReplications().size());
//        for (com.microsoft.azure.v2.management.cosmosdb.Location readReplica : cosmosDBAccount.readableReplications()) {
//            builder.append("\n\t\tRead replication: ")
...
//    }
    ...
    public static void print(ActiveDirectoryUser user) {
        StringBuilder builder = new StringBuilder()
                ...
                .append("\n\tSign In Name: ").append(String.join(", ", user.signInNames()))
...
//        for (com.microsoft.azure.v2.management.eventhub.AccessRights rights : resource.rights()) {
